...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Same Day Doctor - Find Your Nearest Walk In Centre    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="walk in centre">
    <meta name="description" content="Find your nearby walk in centre and get seen by an NHS registered doctor. Book a same day private GP appointment for only £39 and instantly collect any prescribed medication on your way out. Our walk in centre opening times vary clinic by clinic but many operate 9am to 6pm seven days a week.">
    ...
    <div class="container">
        <div class="page-header-wrapper">
            ...
            <nav class="nav-main">
                ...
                <a href="https://www.medicspot.co.uk/our-clinics" class="active btn bokNowbtn" class="btn bokNowbtn">Book Now</a>
	...
	<section id="booking" class="text-section">
		<div class="container">
			<div class="section-header">
				<h1>Walk In Centre At Your Local Pharmacy</h1>
				<p class="subtitle">“How can I find a walk in centre near me?”</p>
				<p class="subtitle">Find your nearest walk in clinic and book a same day private GP appointment</p>
			</div>
...
<link rel="stylesheet" href="https://www.medicspot.co.uk/assets/css/ladda-themeless.min.css">
<script src="https://www.medicspot.co.uk/assets/js/spin.min.js"></script>
<script src="https://www.medicspot.co.uk/assets/js/ladda.min.js"></script>
...
<div id="booking-panel">
	...
	<div class="booking-panel-table">
		...
		<div class="booking-panel-day-selector-wrapper">
			<ul class="booking-panel-day-selector">
				...
				<li class="active" data-date="21-04-2018" data-my-date="2018-04-21">TODAY</li>
								<li class="day-appointments" data-date="22-04-2018" data-clinicId="" data-my-date="2018-04-22">Sun<br>22nd Apr</li>
								<li class="day-appointments" data-date="23-04-2018" data-clinicId="" data-my-date="2018-04-23">Mon<br>23rd Apr</li>
								<li class="day-appointments" data-date="24-04-2018" data-clinicId="" data-my-date="2018-04-24">Tue<br>24th Apr</li>
								<li class="day-appointments" data-date="25-04-2018" data-clinicId="" data-my-date="2018-04-25">Wed<br>25th Apr</li>
								<li class="day-appointments" data-date="26-04-2018" data-clinicId="" data-my-date="2018-04-26">Thu<br>26th Apr</li>
							</ul>
		</div>		
			<img style="display: none;height: 200px; position: absolute; left: 135px; margin-top: 89px;" id="booking-loader" src="https://www.medicspot.co.uk/assets/img/loading.gif">		
	...
	<div class="booking-form" style="display:none;">
		<div class="frame-content " style="max-height: 308px;margin-bottom: 5px;">
			<img style="display: none;" id="confirm-loader" src="https://www.medicspot.co.uk/assets/img/loading.gif">
				<div class="row">
                            ...
                            <div class="form-group form-padding" style="text-align: left;">
                            	...
                            	<tr>
                            		...
                            		<td>
                            			<label class="control-label">I accept the <a href="https://www.medicspot.co.uk/terms">Terms and Conditions</a> (no under 5's)</label>
                            		</td>
                            	</tr>
                            	</table>
                            </div>
...
$( document ).ready(function() { 
	...
	$('body').on('keyup', '#postcode_search', function(){ 	
		if($('#postcode_search').val().length>=2){ 			
			$.ajax({ 
				type: "POST",
				url: 'https://www.medicspot.co.uk/Clinic_search/postcode_search',
	...
	$('#confirm').on('click', function(){ 	
		...
		if(clinic_id < 1){ 
			...
			$.ajax({ 
				type: "POST",
				url: 'https://www.medicspot.co.uk/index.php/appointments/ajax_register_appointment',
				data: { 
				...
				{ 	
					...
					if(data.status==0){ 
						...
						window.location.href="https://www.medicspot.co.uk/booking_confirm";
					}
				}
			});
		}
	...
	$('.booking-input input').click(function () { 
		...
		$.ajax({ 
			type: "POST",
			url: 'https://www.medicspot.co.uk/Clinic_search/search',
	...
	$('body').on('click', '.suggestion', function(){ 
		...
		navigator.geolocation.getCurrentPosition(function(position) { 
			...
			var destLon = globals.lng;
		 	var image = 'https://www.medicspot.co.uk/assets/images/clinic.png';
			...
			var image_start = 'https://www.medicspot.co.uk/assets/images/clinic_start.png';
			var marker = new google.maps.Marker({ 				
...
function loadClinicData(clinic_id, distance){ 
	...
	$.ajax({ 
			type: "POST",
			url: 'https://www.medicspot.co.uk/Clinic_search/clinic_data',
			...
			var marker = new google.maps.Marker({ 				
				...
				if(data.url!=''){ 
					...
					jQuery('#www_span').html('<a href="https://www.medicspot.co.uk/clinics/'+url+'/">More Details</a>');
				}else{ 
					jQuery('#www_span').html('<a href="https://www.medicspot.co.uk/establishment/'+data.clinic_id+'">More Details</a>');	
				}
				

				if(data.image1!=''){ 
					jQuery('.photo1').attr('style',"background-image:url(https://www.medicspot.co.uk/assets/images/"+data.image1+");");
				}
				if(data.image2!=''){ 
					jQuery('.photo2').attr('style',"background-image:url(https://www.medicspot.co.uk/assets/images/"+data.image2+");");
				}
				if(data.image3!=''){ 
					jQuery('.photo3').attr('style',"background-image:url(https://www.medicspot.co.uk/assets/images/"+data.image3+");");
				}
			}
	});
}
...
function getAppointmentTimes(clinic_id, date){ 
	...
	$.ajax({ 
			type: "POST",
			url: 'https://www.medicspot.co.uk/index.php/appointments/ajax_get_available_hours',
	...
	<section id="logos-qa">
		<div class="container">
			<div class="logos-list">
				<img src="https://www.medicspot.co.uk/assets/images/logo/logo-st.png" title="Secure &amp; trusted">
				<img src="https://www.medicspot.co.uk/assets/images/logo/logo-gmc.png" title="General Medical Council">
				<img src="https://www.medicspot.co.uk/assets/images/logo/logo-ico.png" title="Information Commissioner’s Office">
				<img src="https://www.medicspot.co.uk/assets/images/logo/logo-cqc.png" title="CareQuality Commission">
			</div>
		</div>
	</section>
		<div class="column">
		<div class="inner">
			<h1>Our Growing Network of Local Walk In Centres</h1>
								<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/south-hampstead/abbey-road-clinic" class="anchor">MedicSpot Clinic Abbey Road</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/city-of-london/clerkenwell/barbican-clinic" class="anchor">MedicSpot Clinic Barbican</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/wandsworth/battersea/battersea-clinic" class="anchor">MedicSpot Clinic Battersea</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/hertfordshire/berkhamsted/berkhamsted-clinic" class="anchor">MedicSpot Clinic Berkhamsted</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/buckinghamshire/milton-keynes/bletchley-clinic" class="anchor">MedicSpot Clinic Bletchley</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/west-yorkshire/bradford/bradford-shearbridge-clinic" class="anchor">MedicSpot Clinic Bradford Shearbridge</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/bristol/bristol/bristol-stapleton-road-clinic" class="anchor">MedicSpot Clinic Bristol Stapleton Road</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/cambridgeshire/cambridge/cambridge-fitzwilliam-clinic" class="anchor">MedicSpot Clinic Cambridge Fitzwilliam</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/kensington-chelsea/chelsea/chelsea-clinic" class="anchor">MedicSpot Clinic Chelsea</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/lambeth/clapham/clapham-clinic" class="anchor">MedicSpot Clinic Clapham</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/camden/cricklewood/cricklewood-clinic" class="anchor">MedicSpot Clinic Cricklewood</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/scotland/dundee/dundee/dundee-clinic" class="anchor">MedicSpot Clinic Dundee</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/kensington-chelsea/kensington/earls-court-clinic" class="anchor">MedicSpot Clinic Earls Court</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/scotland/lanarkshire/east-kilbride/east-kilbride-clinic" class="anchor">MedicSpot Clinic East Kilbride</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/scotland/edinburgh/edinburgh/edinburgh-clerk-street-clinic" class="anchor">MedicSpot Clinic Edinburgh Clerk Street</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/southwark/newington/elephant-and-castle-clinic" class="anchor">MedicSpot Clinic Elephant and Castle</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/camden/euston/euston-clinic" class="anchor">MedicSpot Clinic Euston</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/scotland/glasgow/glasgow/glasgow-city-centre-clinic" class="anchor">MedicSpot Clinic Glasgow City Centre</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/westminster/mayfair/grosvenor-square-clinic" class="anchor">MedicSpot Clinic Grosvenor Square</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/harrow/harrow/harrow-on-the-hill-clinic" class="anchor">MedicSpot Clinic Harrow on the Hill</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/kensington-chelsea/holland-park/holland-park-clinic" class="anchor">MedicSpot Clinic Holland Park</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/westminster/hyde-park/hyde-park-clinic" class="anchor">MedicSpot Clinic Hyde Park</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/hounslow/isleworth/isleworth-clinic" class="anchor">MedicSpot Clinic Isleworth</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/islington/islington/islington-clinic" class="anchor">MedicSpot Clinic Islington</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/kensington-chelsea/kensington/kensington-clinic" class="anchor">MedicSpot Clinic Kensington</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/west-yorkshire/leeds/leeds-roundhay-clinic" class="anchor">MedicSpot Clinic Leeds Roundhay</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/bedfordshire/luton/luton-biscot-clinic" class="anchor">MedicSpot Clinic Luton Biscot</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/westminster/mayfair/mayfair-clinic" class="anchor">MedicSpot Clinic Mayfair</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/kensington-chelsea/notting-hill/notting-hill-clinic" class="anchor">MedicSpot Clinic Notting Hill</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/nottinghamshire/nottingham/nottingham-alfreton-road-clinic" class="anchor">MedicSpot Clinic Nottingham Alfreton Road</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/oxfordshire/oxford/oxford-clinic" class="anchor">MedicSpot Clinic Oxford</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/westminster/paddington/paddington-clinic" class="anchor">MedicSpot Clinic Paddington</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/westminster/pimlico/pimlico-clinic" class="anchor">MedicSpot Clinic Pimlico</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/kensington-chelsea/notting-hill/portobello-market-clinic" class="anchor">MedicSpot Clinic Portobello Market</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/camden/primrose-hill/primrose-hill-clinic" class="anchor">MedicSpot Clinic Primrose Hill</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/south-yorkshire/sheffield/sheffield-wicker-clinic" class="anchor">MedicSpot Clinic Sheffield Wicker</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/hammersmith-fulham/shepherds-bush/shepherds-bush-clinic" class="anchor">MedicSpot Clinic Shepherds Bush</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/kent/sheerness/sheppey-hospital-clinic" class="anchor">MedicSpot Clinic Sheppey Hospital</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/kensington-chelsea/kensington/south-kensington-clinic" class="anchor">MedicSpot Clinic South Kensington</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/kensington-chelsea/kensington/south-kensington-station-clinic" class="anchor">MedicSpot Clinic South Kensington Station</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/southwark/southwark/southwark-clinic" class="anchor">MedicSpot Clinic Southwark</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/westminster/st-johns-wood/st-johns-wood-clinic" class="anchor">MedicSpot Clinic St Johns Wood</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/lambeth/stockwell/stockwell-clinic" class="anchor">MedicSpot Clinic Stockwell</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/southwark/bermondsey/tower-bridge-clinic" class="anchor">MedicSpot Clinic Tower Bridge</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/camden/kentish-town/tufnell-park-clinic" class="anchor">MedicSpot Clinic Tufnell Park</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/westminster/belgravia/victoria-clinic" class="anchor">MedicSpot Clinic Victoria</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/brent/willesden/willesden-clinic" class="anchor">MedicSpot Clinic Willesden</a>
					</div> 					<div class="our-clinic-section">
						<a href="https://www.medicspot.co.uk/clinics/england/london/greenwich/woolwich/woolwich-clinic" class="anchor">MedicSpot Clinic Woolwich</a>
					</div> 		</div>
	</div>
	<section id="call-to-action" class="call-to-action" style="width:100%;float:left;">
		<div class="container">
			<h1>Find your nearest pharmacy walk in centre</h1>
			<p>Same day walk in doctor service.</p>
...
$( document ).ready(function() { 
	...
	markerIcon = new google.maps.MarkerImage(
		'https://www.medicspot.co.uk/assets/images/map-marker.png',
	...
	// Add Markers.
		...
		marker = new google.maps.Marker({ 
		position: { 
			lat: parseFloat(51.5173313),
			lng: parseFloat(-0.1248945)
		},
		icon: markerIcon,
		map: map
	});
	...
	function booking_Map() { 
		...
		// Add Markers.
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(16);
					booking_SelectEstablishment();
					getAppointmentTimes(16, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(17);
					booking_SelectEstablishment();
					getAppointmentTimes(17, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(18);
					booking_SelectEstablishment();
					getAppointmentTimes(18, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(21);
					booking_SelectEstablishment();
					getAppointmentTimes(21, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(22);
					booking_SelectEstablishment();
					getAppointmentTimes(22, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(23);
					booking_SelectEstablishment();
					getAppointmentTimes(23, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(24);
					booking_SelectEstablishment();
					getAppointmentTimes(24, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(25);
					booking_SelectEstablishment();
					getAppointmentTimes(25, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(26);
					booking_SelectEstablishment();
					getAppointmentTimes(26, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(28);
					booking_SelectEstablishment();
					getAppointmentTimes(28, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(29);
					booking_SelectEstablishment();
					getAppointmentTimes(29, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(30);
					booking_SelectEstablishment();
					getAppointmentTimes(30, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(31);
					booking_SelectEstablishment();
					getAppointmentTimes(31, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(32);
					booking_SelectEstablishment();
					getAppointmentTimes(32, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(33);
					booking_SelectEstablishment();
					getAppointmentTimes(33, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(34);
					booking_SelectEstablishment();
					getAppointmentTimes(34, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(35);
					booking_SelectEstablishment();
					getAppointmentTimes(35, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(36);
					booking_SelectEstablishment();
					getAppointmentTimes(36, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(37);
					booking_SelectEstablishment();
					getAppointmentTimes(37, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(38);
					booking_SelectEstablishment();
					getAppointmentTimes(38, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(39);
					booking_SelectEstablishment();
					getAppointmentTimes(39, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(40);
					booking_SelectEstablishment();
					getAppointmentTimes(40, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(41);
					booking_SelectEstablishment();
					getAppointmentTimes(41, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(42);
					booking_SelectEstablishment();
					getAppointmentTimes(42, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(43);
					booking_SelectEstablishment();
					getAppointmentTimes(43, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(44);
					booking_SelectEstablishment();
					getAppointmentTimes(44, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(45);
					booking_SelectEstablishment();
					getAppointmentTimes(45, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(46);
					booking_SelectEstablishment();
					getAppointmentTimes(46, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(47);
					booking_SelectEstablishment();
					getAppointmentTimes(47, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(48);
					booking_SelectEstablishment();
					getAppointmentTimes(48, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(49);
					booking_SelectEstablishment();
					getAppointmentTimes(49, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(50);
					booking_SelectEstablishment();
					getAppointmentTimes(50, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(51);
					booking_SelectEstablishment();
					getAppointmentTimes(51, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(52);
					booking_SelectEstablishment();
					getAppointmentTimes(52, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(53);
					booking_SelectEstablishment();
					getAppointmentTimes(53, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(54);
					booking_SelectEstablishment();
					getAppointmentTimes(54, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(55);
					booking_SelectEstablishment();
					getAppointmentTimes(55, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(56);
					booking_SelectEstablishment();
					getAppointmentTimes(56, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(57);
					booking_SelectEstablishment();
					getAppointmentTimes(57, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(58);
					booking_SelectEstablishment();
					getAppointmentTimes(58, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(59);
					booking_SelectEstablishment();
					getAppointmentTimes(59, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(61);
					booking_SelectEstablishment();
					getAppointmentTimes(61, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(62);
					booking_SelectEstablishment();
					getAppointmentTimes(62, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(63);
					booking_SelectEstablishment();
					getAppointmentTimes(63, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(65);
					booking_SelectEstablishment();
					getAppointmentTimes(65, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(66);
					booking_SelectEstablishment();
					getAppointmentTimes(66, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(67);
					booking_SelectEstablishment();
					getAppointmentTimes(67, '21-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(68);
					booking_SelectEstablishment();
					getAppointmentTimes(68, '21-04-2018');	
