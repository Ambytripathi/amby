	...
	<div class="booking-panel-table">
		...
		<div class="booking-panel-day-selector-wrapper">
			<ul class="booking-panel-day-selector">
				...
				<li class="active" data-date="22-04-2018" data-my-date="2018-04-22">TODAY</li>
	...
	function booking_Map() { 
		...
		// Add Markers.
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(16);
					booking_SelectEstablishment();
					getAppointmentTimes(16, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(17);
					booking_SelectEstablishment();
					getAppointmentTimes(17, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(18);
					booking_SelectEstablishment();
					getAppointmentTimes(18, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(21);
					booking_SelectEstablishment();
					getAppointmentTimes(21, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(22);
					booking_SelectEstablishment();
					getAppointmentTimes(22, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(23);
					booking_SelectEstablishment();
					getAppointmentTimes(23, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(24);
					booking_SelectEstablishment();
					getAppointmentTimes(24, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(25);
					booking_SelectEstablishment();
					getAppointmentTimes(25, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(26);
					booking_SelectEstablishment();
					getAppointmentTimes(26, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(28);
					booking_SelectEstablishment();
					getAppointmentTimes(28, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(29);
					booking_SelectEstablishment();
					getAppointmentTimes(29, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(30);
					booking_SelectEstablishment();
					getAppointmentTimes(30, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(31);
					booking_SelectEstablishment();
					getAppointmentTimes(31, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(32);
					booking_SelectEstablishment();
					getAppointmentTimes(32, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(33);
					booking_SelectEstablishment();
					getAppointmentTimes(33, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(34);
					booking_SelectEstablishment();
					getAppointmentTimes(34, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(35);
					booking_SelectEstablishment();
					getAppointmentTimes(35, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(36);
					booking_SelectEstablishment();
					getAppointmentTimes(36, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(37);
					booking_SelectEstablishment();
					getAppointmentTimes(37, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(38);
					booking_SelectEstablishment();
					getAppointmentTimes(38, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(39);
					booking_SelectEstablishment();
					getAppointmentTimes(39, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(40);
					booking_SelectEstablishment();
					getAppointmentTimes(40, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(41);
					booking_SelectEstablishment();
					getAppointmentTimes(41, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(42);
					booking_SelectEstablishment();
					getAppointmentTimes(42, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(43);
					booking_SelectEstablishment();
					getAppointmentTimes(43, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(44);
					booking_SelectEstablishment();
					getAppointmentTimes(44, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(45);
					booking_SelectEstablishment();
					getAppointmentTimes(45, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(46);
					booking_SelectEstablishment();
					getAppointmentTimes(46, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(47);
					booking_SelectEstablishment();
					getAppointmentTimes(47, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(48);
					booking_SelectEstablishment();
					getAppointmentTimes(48, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(49);
					booking_SelectEstablishment();
					getAppointmentTimes(49, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(50);
					booking_SelectEstablishment();
					getAppointmentTimes(50, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(51);
					booking_SelectEstablishment();
					getAppointmentTimes(51, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(52);
					booking_SelectEstablishment();
					getAppointmentTimes(52, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(53);
					booking_SelectEstablishment();
					getAppointmentTimes(53, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(54);
					booking_SelectEstablishment();
					getAppointmentTimes(54, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(55);
					booking_SelectEstablishment();
					getAppointmentTimes(55, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(56);
					booking_SelectEstablishment();
					getAppointmentTimes(56, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(57);
					booking_SelectEstablishment();
					getAppointmentTimes(57, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(58);
					booking_SelectEstablishment();
					getAppointmentTimes(58, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(59);
					booking_SelectEstablishment();
					getAppointmentTimes(59, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(61);
					booking_SelectEstablishment();
					getAppointmentTimes(61, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(62);
					booking_SelectEstablishment();
					getAppointmentTimes(62, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(63);
					booking_SelectEstablishment();
					getAppointmentTimes(63, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(65);
					booking_SelectEstablishment();
					getAppointmentTimes(65, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(66);
					booking_SelectEstablishment();
					getAppointmentTimes(66, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(67);
					booking_SelectEstablishment();
					getAppointmentTimes(67, '22-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(68);
					booking_SelectEstablishment();
					getAppointmentTimes(68, '22-04-2018');	
