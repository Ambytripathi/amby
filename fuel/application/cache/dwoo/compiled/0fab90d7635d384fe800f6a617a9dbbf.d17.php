		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Bradford.jpg)" aria-label="MedicSpot Clinic Bradford Shearbridge" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Bradford_Consulting_Room.jpg)" aria-label="MedicSpot Clinic Bradford Shearbridge" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Bradford_Clinical_Station.jpg)" aria-label="MedicSpot Clinic Bradford Shearbridge" ></div>
											</div>
