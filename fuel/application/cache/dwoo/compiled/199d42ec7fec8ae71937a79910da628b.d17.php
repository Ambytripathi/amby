		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Portobello_Doctors_Clinic.JPG)" aria-label="MedicSpot Clinic Portobello Market" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Portobello_Doctors_Clinic_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Portobello Market" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Portobello_Doctors_Clinic_Sign.JPG)" aria-label="MedicSpot Clinic Portobello Market" ></div>
											</div>
