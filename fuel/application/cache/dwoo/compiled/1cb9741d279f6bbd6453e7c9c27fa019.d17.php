		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Bristol.jpg)" aria-label="MedicSpot Clinic Bristol Stapleton Road" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Bristol_Consulting_Room.jpg)" aria-label="MedicSpot Clinic Bristol Stapleton Road" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Bristol_Clinical_Station.JPG)" aria-label="MedicSpot Clinic Bristol Stapleton Road" ></div>
											</div>
