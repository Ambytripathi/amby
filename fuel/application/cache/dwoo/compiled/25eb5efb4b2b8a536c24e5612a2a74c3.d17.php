...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Walk In Clinic Holborn - Same Day Access to Private GPs    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Walk In Clinic Holborn">
    <meta name="description" content="Same day GP appointments from MedicSpot's Walk In Clinic Holborn. Our Walk In Clinic Holborn is conveniently located on Bloomsbury Way inside Kerrs Chemist. Skip the wait, select a time, and book a private GP Holborn appointment for only £39.">
...
globals = { };
globals.lat = '51.5173313';
globals.lng = '-0.1248945';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Holborn</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To Visit Our Walk In Clinic Holborn						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Holborn</p>
				</li>
				<li>
					...
					<h3>Visit Our Holborn Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>41 Bloomsbury Way, Holborn, London WC1A 2SA, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3555</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-clock-o" title="Opening Times"></i>
						<span>
							<strong>Opening Times</strong><br>
							<table cellpadding="10" cellspacing="10"><tr><td>Monday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Tuesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Wednesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Thursday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Friday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Saturday:</td><td> 10:00 to 14:00 </td></tr><tr><td>Sunday:</td><td> Closed</td></tr></table>						</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-envelope" title="Email Address"></i>
						<span>
							<a href="mailto:holborn@medicspot.co.uk">holborn@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day doctor Holborn service from MedicSpot Clinic Holborn. Easily see a private GP in Holborn from MedicSpot's Walk In Clinic Holborn using Central or Piccadilly lines from Holborn Underground Station (5-minute walk) or Central or Northern lines from Tottenham Court Road Station (5-minute walk). If you're looking for a private GP near Holborn or a Holborn medical centre walk in centre, our Walk In Clinic Holborn is less than 0.5 miles from The British Museum and London School of Economics and Political Science, ideal for tourists and students who are unable to register with an NHS walk in centre.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3555" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Clinic_Holborn_.JPG)" aria-label="MedicSpot Clinic Holborn" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Clinic_Holborn_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Holborn" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Clinic_Holborn_Clinical_Station.JPG)" aria-label="MedicSpot Clinic Holborn" ></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Holborn GP Today</h1>
            <p>Visit our Holborn walk in centre to see a private GP</p>
