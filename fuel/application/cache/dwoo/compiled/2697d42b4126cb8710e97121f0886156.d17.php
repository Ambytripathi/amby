...
<div id="NEEDHELP_MODEL" class="modal">
  <div class="modal-content">
    ...
    <div class="block one">
        <img src="https://www.medicspot.co.uk/assets/images/client_msg.png" alt="" />
...
$( document ).ready(function(){ 
    ...
    <section id="steps" class="steps howWeHelpYou">
        <div class="container">
            ...
            <ul class="steps-list">
                <li>
                    <img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/clock.png">
                ...
                <li>
                    <img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/stethoscope.png">
                ...
                <li>
                    <img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/documentapprove.png">
