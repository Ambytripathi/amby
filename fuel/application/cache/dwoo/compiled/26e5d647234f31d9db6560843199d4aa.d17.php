...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Skip The Wait - Same Day Private GP Glasgow Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="GP Glasgow">
    <meta name="description" content="Same day private GP Glasgow appointments for only £39. MedicSpot's GP Glasgow Walk In Centre is conveniently located in the City Centre inside High Street Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '55.859139';
globals.lng = '-4.240898';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Glasgow City Centre</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A GP In Glasgow						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Glasgow City Centre</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Glasgow Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>128 High St, Glasgow G1 1PQ, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>0141 406 5808</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:glasgowcentre@medicspot.co.uk">glasgowcentre@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Skip the wait and book a private GP Glasgow appointment at a time that suits you. If you're looking for a 'GP near me Glasgow', a 'GP near me Scotland' or a GP in Clydebank or Paisley, MedicSpot Clinic Glasgow City Centre is only a 1-minute walk from Glasgow High Street Station. This service is ideal for those who find it difficult to get an appointment with an NHS GP in Glasgow City Centre, those who find it difficult learning how to register with a GP for the first time, or those who find it difficult registering with a GP in Scotland. There is good wheelchair access at this private GP Glasgow Clinic.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:0141 406 5808" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Glasgow_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Glasgow_Clinic_Consulting_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Glasgow_Clinical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Glasgow GP Today</h1>
            <p>Visit our Glasgow walk in centre to see a private GP</p>
