		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Walk_In_Centre_Luton.jpg)" aria-label="MedicSpot Clinic Luton Biscot" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Luton_Consulting_Room.jpg)" aria-label="MedicSpot Clinic Luton Biscot" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Luton_Clinical_Station.jpg)" aria-label="MedicSpot Clinic Luton Biscot" ></div>
											</div>
