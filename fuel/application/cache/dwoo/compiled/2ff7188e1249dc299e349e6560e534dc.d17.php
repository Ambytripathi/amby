...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Doctor Partnerships    </title>
	...
	<section id="contact-info" class="dots-background text-section">
		<div class="container">
			<div class="section-header">
				<h1>Join The Safest Digital Healthcare Provider</h1>
				<p class="subtitle"><!--__FUEL_MARKER__1-->We recruit only the best doctors who want to be involved in an exciting and innovative method of healthcare delivery.</p>
			</div>
			<div class="content">
				<p>
					<!--__FUEL_MARKER__2-->If you&rsquo;re looking to join a rapidly growing digital health company in a clinical capacity with loads of room for professional growth and development; MedicSpot may just be up your street.  Get in touch for more information.	
				</p>
			</div>
		</div>
	</section>
