		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clapham_GP_Clinic.jpg)" aria-label="MedicSpot Clinic Clapham" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clapham_GP_Clinic_Consulting_Room.jpg)" aria-label="MedicSpot Clinic Clapham" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clapham_GP_Medical_Station.JPG)" aria-label="MedicSpot Clinic Clapham" ></div>
											</div>
