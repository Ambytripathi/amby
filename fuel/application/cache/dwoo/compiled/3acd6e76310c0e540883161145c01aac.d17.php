			...
			<div class="content">
                ...
                <p class="confirm_msg_p">
                    <span style="text-align:center;color: #000;font-weight:bold;"><b>Appointment Details:</b></span>
                        <br>
                        Elena Colato<br>
                    Appointment 22/04/2018, 15:30 at 
                       
                    MedicSpot Clinic Nottingham Alfreton Road
                        <br>
                        <br>
                    <span style="color: #ff585b;">Midnight Pharmacy Nottingham</span>
                        <br>
                    194 Alfreton Rd, Nottingham NG7 3PE, United Kingdom
                        <br>
                        <br>
