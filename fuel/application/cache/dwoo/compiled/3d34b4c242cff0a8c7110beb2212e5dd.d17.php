...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Sheppey Walk In Centre - Same Day Private GP Appointments    </title>
    	
	
	<meta name="title" content="Book & Visit MedicSpot's Sheppey Walk In Centre">
    <meta name="keywords" content="Sheppey Walk In Centre">
    <meta name="description" content="Sheppey Walk In Centre same day appointments for only £39. MedicSpot's Sheppey Walk In Centre is conveniently located on Plover Road inside Delmergate Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.415159';
globals.lng = '0.795122';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Sheppey Hospital</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To Visit Our Sheppey Walk In Centre						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Sheppey Hospital</p>
				</li>
				<li>
					...
					<h3>Visit Our Sheppey Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>Plover Rd, Minster on Sea, Sheerness ME12 3LT, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>01795 505230</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:sheppeyhospital@medicspot.co.uk">sheppeyhospital@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day private GP appointment from MedicSpot Clinic Sheppey Hospital. The Sheppey walk in centre is located inside Delmergate Pharmacy. You can easily access the Sheppey walk in centre from the south using Lower Rd A2500 or the north using Minster Rd B2008. Our private GP services compliment the Sheppey Community Hospital walk in center by offering instant access to private GPs. You no longer have to wait hours for an appointment with your regular NHS GP - simply select a convenient time and day, book online, and visit our Sheppey walk in centre.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:01795 505230" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Sheppey_Walk_In_Centre.JPG)" aria-label="MedicSpot Clinic Sheppey Hospital" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Sheppey_Walk_In_Centre_Side_Entrance.JPG)" aria-label="MedicSpot Clinic Sheppey Hospital" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Sheppey_Walk_In_Centre_Clinical_Station.JPG)" aria-label="MedicSpot Clinic Sheppey Hospital" ></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Sheppey GP Today</h1>
            <p>Visit our Sheppey walk in centre to see a private GP</p>
