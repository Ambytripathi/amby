...
<head>
    ...
    <meta name="keywords" content="A useful guide to the NHS aimed at students, from MedicSpot - the UK's walk in GP service.">
		...
		<section id="blog-index-header" class="text-section">
			<div class="container">
				<div class="section-header">
					<h1><!--__FUEL_MARKER__1-->A Guide to the NHS for Students</h1>
