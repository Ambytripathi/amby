...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Tower Bridge GP Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Tower Bridge GP">
    <meta name="description" content="Same day Tower Bridge GP appointments for only £39. MedicSpot's Tower Bridge GP Walk In Centre is conveniently located on Tower Bridge Road inside Harfleur Chemist. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.496723';
globals.lng = '-0.082512';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Tower Bridge</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A Tower Bridge GP						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Tower Bridge</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Tower Bridge Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>107 Tower Bridge Rd, London SE1 4TW, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3680</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:towerbridge@medicspot.co.uk">towerbridge@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Skip the wait and book a Tower Bridge GP appointment at a time that suits you. MedicSpot's Tower Bridge GP Walk In Centre is conveniently located on Tower Bridge Road inside Harfleur Chemist. MedicSpot Clinic Tower Bridge is ideal for commuters, travellers, and residents in the area looking for a same day private GP. You no longer have to wait weeks for an appointment with your regular NHS GP. Select a time with a private Tower Bridge GP, book online, and see a private doctor instantly.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3680" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Tower_Bridge_GP_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Tower_Bridge_GP_Clinic_Consulting_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Tower_Bridge_GP_Clinic_Medical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Tower Bridge GP Today</h1>
            <p>Visit our Tower Bridge walk in centre to see a private GP</p>
