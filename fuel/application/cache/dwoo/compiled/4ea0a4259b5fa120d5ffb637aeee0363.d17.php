...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Primrose Hill Doctors Service    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Primrose Hill Doctors">
    <meta name="description" content="Same day Primrose Hill doctors appointment for only £39. MedicSpot's Primrose Hill Doctors Clinic is conveniently located on England's Lane inside Allchin Primrose Hill Pharmacy. Skip the wait, select a time, and book a private GP appointment.">
...
globals = { };
globals.lat = '51.5461186';
globals.lng = '-0.1620878';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Primrose Hill</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See Our Primrose Hill Doctors						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Primrose Hill</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Primrose Hill Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>28 England's Ln, Primrose Hill, London NW3 4UE, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3688</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:primrosehill@medicspot.co.uk">primrosehill@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day Primrose Hill doctors appointment from Allchin Primrose Hill Pharmacy. You can easily see a private GP from MedicSpot's Primrose Surgery using the Northern line from Belsize Park Underground Station (8-minute walk). MedicSpot Clinic Primrose Hill Surgery opening times are 9am-6pm Monday-Saturday. Seeing MedicSpot Primrose Hill doctors would be a convenient alternative to your regular NHS GP if you're living, working, or visiting in the area. Skip the wait and book a Primrose Hill doctors appointment at a time that suits you.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3688" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Primrose_Hill_Doctors_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Primrose_Hill_Doctors_Clinic_Consulting_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Primrose_Hill_Doctors_Medical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Primrose Hill GP Today</h1>
            <p>Visit our Primrose Hill walk in centre to see a private GP</p>
