...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Private Clapham GP Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Clapham GP">
    <meta name="description" content="Same day Clapham GP appointments for only £39. MedicSpot's Clapham Surgery is conveniently located on Clapham High Street inside Pearl Pharmacy. Skip the wait and book a private Clapham doctors appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.4642822';
globals.lng = '-0.1310743';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Clapham</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A Clapham GP						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Clapham</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Clapham Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>31 Clapham High St, Clapham, London SW4 7TR, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3667</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-clock-o" title="Opening Times"></i>
						<span>
							<strong>Opening Times</strong><br>
							<table cellpadding="10" cellspacing="10"><tr><td>Monday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Tuesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Wednesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Thursday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Friday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Saturday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Sunday:</td><td> 09:00 to 18:00 </td></tr></table>						</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-envelope" title="Email Address"></i>
						<span>
							<a href="mailto:clapham@medicspot.co.uk">clapham@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Skip the wait and book a private GP Clapham North appointment at a time that suits you. You can easily see a Clapham GP from MedicSpot's Clapham Doctors Surgery using the Northern line from Clapham North Underground Station (2-minute walk) or Overground services from Clapham High Street Station (2-minute walk). MedicSpot Clinic Clapham is less than 0.4 miles away for those looking for a private GP in Clapham Common, making it ideal for commuters and residents who are unable to register with a Clapham GP NHS Surgery. Simply select a time and book online to see a Clapham GP instantly.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3667" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clapham_GP_Clinic.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clapham_GP_Clinic_Consulting_Room.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clapham_GP_Medical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Clapham GP Today</h1>
            <p>Visit our Clapham walk in centre to see a private GP</p>
