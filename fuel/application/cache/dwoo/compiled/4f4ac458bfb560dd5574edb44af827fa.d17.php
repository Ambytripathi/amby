...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Hyde Park GP Appointments    </title>
    	
	
	<meta name="title" content="Book Same Day Hyde Park GP Appointment">
    <meta name="keywords" content="Hyde Park GP">
    <meta name="description" content="Same day Hyde Park GP appointments for only £39. MedicSpot's Hyde Park GP Walk In Centre is conveniently located on Kendal Street inside Hogg & Son Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.514655';
globals.lng = '-0.166613';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Hyde Park</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A Hyde Park GP						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Hyde Park</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Hyde Park Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>25 Kendal St, London W2 2AW, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3637 8398</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:hydepark@medicspot.co.uk">hydepark@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day Hyde Park GP appointments from Hogg & Son Pharmacy. You can easily see a Hyde Park GP from our MedicSpot Clinic Hyde Park using the Central line from Marble Arch Underground Station (8-minute walk) or Circle, District, or Hammersmith & City lines from Edgeware Road Underground Station (10-minute walk). You no longer have to wait weeks for an appointment with your regular NHS GP. Select a time with a Hyde Park GP, book online, and see a private doctor instantly.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3637 8398" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Hyde_Park_GP_Clinic.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Hyde_Park_GP_Clinic_Consultation_Room.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Hyde_Park_GP_Clinic_Medical_Station.jpg)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Hyde Park GP Today</h1>
            <p>Visit our Hyde Park walk in centre to see a private GP</p>
