...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Walk In Centre Sheffield - See a Private GP Same Day    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Walk In Centre Sheffield">
    <meta name="description" content="Same day private GP appointments from MedicSpot's Walk In Centre Sheffield. Our Walk In Centre Sheffield opening times are 9am-6pm Monday-Saturday and 10am-6pm on Sunday. Skip the wait and book an appointment for only £39 at a time that suits you.">
...
globals = { };
globals.lat = '53.3873755';
globals.lng = '-1.4621793';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Sheffield Wicker</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To Visit Our Walk In Centre Sheffield						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Sheffield Wicker</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Sheffield Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>55 Wicker, Sheffield S3 8HT, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>0114 478 5437</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:wicker@medicspot.co.uk">wicker@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day private GP appointments from MedicSpot Clinic Sheffield Wicker. MedicSpot's Walk In Centre Sheffield is located inside Wicker Pharmacy. Our Walk In Centre Sheffield opening times are 9am-6pm Monday-Saturday and 10am-6pm on Sunday. Any prescribed medication can be collected instantly on your way out. You no longer have to wait weeks for an appointment with your regular NHS GP - simply select a convenient time and day, book online, and visit our Walk In Centre Sheffield.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:0114 478 5437" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Sheffield_Wicker.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Sheffield_Consulting_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Sheffield_Clinical_Station.jpg)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Sheffield GP Today</h1>
            <p>Visit our Sheffield walk in centre to see a private GP</p>
