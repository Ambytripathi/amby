		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Abbey_Road_GP_Hodgetts_Chemist.JPG)" aria-label="MedicSpot Clinic Abbey Road" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Abbey_Road_GP_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Abbey Road" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clinical_Station.JPG)" aria-label="MedicSpot Clinic Abbey Road" ></div>
											</div>
