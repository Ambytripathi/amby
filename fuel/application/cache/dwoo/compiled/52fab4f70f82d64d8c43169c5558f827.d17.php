...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Skip The Wait - Same Day GP Cambridge Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="GP Cambridge">
    <meta name="description" content="Same day private GP Cambridge appointments for only £39. MedicSpot's Walk In GP Cambridge is conveniently located on Trumpington Street inside Fitzwilliam Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '52.200338';
globals.lng = '0.120241';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Cambridge Fitzwilliam</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A GP In Cambridge						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Cambridge Fitzwilliam</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Cambridge Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>28-30 Trumpington St, Cambridge CB2 1QZ, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>01223 800935</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-clock-o" title="Opening Times"></i>
						<span>
							<strong>Opening Times</strong><br>
							<table cellpadding="10" cellspacing="10"><tr><td>Monday:</td><td> 09:00 to 17:30 </td></tr><tr><td>Tuesday:</td><td> 09:00 to 17:30 </td></tr><tr><td>Wednesday:</td><td> 09:00 to 17:30 </td></tr><tr><td>Thursday:</td><td> 09:00 to 17:30 </td></tr><tr><td>Friday:</td><td> 09:00 to 17:30 </td></tr><tr><td>Saturday:</td><td> Closed</td></tr><tr><td>Sunday:</td><td> Closed</td></tr></table>						</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-envelope" title="Email Address"></i>
						<span>
							<a href="mailto:cambridge@medicspot.co.uk">cambridge@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Skip the wait and book a GP Cambridge appointment at a time that suits you. MedicSpot's Walk In GP Cambridge Clinic is conveniently located on Trumpington Street inside Fitzwilliam Pharmacy. MedicSpot Clinic Cambridge Fitzwilliam is close to many of the university campuses, making it ideal for students who are reluctant to wait for appointments with their regular GP or do not have the time to learn how to register with a GP. If you live, work, or study in the city, simply select a time, book online, and see a private doctor instantly.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:01223 800935" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Cambridge_Clinic.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Cambridge_Clinic_Inside.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Cambridge_Clinic_Medical_Station.jpg)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Cambridge GP Today</h1>
            <p>Visit our Cambridge walk in centre to see a private GP</p>
