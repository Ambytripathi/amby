...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Bletchley Doctors Service    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Bletchley Doctors">
    <meta name="description" content="Same day Bletchley doctors appointment for only £39. MedicSpot's Bletchley Doctors Walk In Centre is conveniently located on Queensway inside Queensway Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.9952375';
globals.lng = '-0.7278389';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Bletchley</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See Our Bletchley Doctors						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Bletchley</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Bletchley Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>143 Queensway, Bletchley, Milton Keynes MK2 2DY, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>01908 018784</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-clock-o" title="Opening Times"></i>
						<span>
							<strong>Opening Times</strong><br>
							<table cellpadding="10" cellspacing="10"><tr><td>Monday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Tuesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Wednesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Thursday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Friday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Saturday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Sunday:</td><td> 10:00 to 18:00 </td></tr></table>						</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-envelope" title="Email Address"></i>
						<span>
							<a href="mailto:bletchley@medicspot.co.uk">bletchley@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day Bletchley doctors appointment from Queensway Pharmacy. You can easily see a private GP from MedicSpot's Bletchley Doctors Walk In Centre located on Queensway. MedicSpot Clinic Bletchley is an online private GP service where you can instantly speak to one of our expert NHS registered doctors Monday to Sunday. MedicSpot's Bletchley Doctors Clinic is less than a 15-minute drive for patients looking for doctors surgeries in Milton Keynes, a GP surgery in Milton Keynes, or a 'GP near me'. This service is ideal for those who find it difficult to get a Bletchley doctors appointment. Select a time, book online, and see a private doctor instantly.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:01908 018784" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Bletchley_Doctors_Clinic.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Bletchley_Doctors_Consultation_Room.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Bletchley_Doctors_Clinical_Station.jpg)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Bletchley GP Today</h1>
            <p>Visit our Bletchley walk in centre to see a private GP</p>
