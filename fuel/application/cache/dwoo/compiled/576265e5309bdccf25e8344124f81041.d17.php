    ...
    <div class="container">
        <div class="page-header-wrapper">
            ...
            <nav class="nav-main">
                ...
                <a href="https://www.medicspot.co.uk/how-it-works" class="active">How it works</a>
...
<page id="how-it-works">
	...
	<section id="steps" class="steps">
		<div class="container">
			<ul class="steps-list">
				<li>
					<img class="step-icon" src="assets/images/icons/Private-GP-Near-Me-Icon.png">
				...
				<li>
					<img class="step-icon" src="assets/images/icons/Online-Doctor.png">
					<h3>Have an online consultation with one of our expert GPs</h3>
				</li>
				<li>
					<img class="step-icon" src="assets/images/icons/Prescription.png">
