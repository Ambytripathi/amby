...
<head>
    ...
    <meta name="description" content="Same day Abbey Road doctors appointments for only £39. MedicSpot's Abbey Road Doctors Walk In Centre is conveniently located on Abbey Road inside Hodgetts Chemist. Skip the wait and book a private GP appointment at a time that suits you.">
		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Abbey_Road_GP_Clinic_.JPG)" aria-label="MedicSpot Clinic Abbey Road" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Abbey_Road_GP_Clinic_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Abbey Road" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Abbey_Road_GP_Clinic_Medical_Station.JPG)" aria-label="MedicSpot Clinic Abbey Road" ></div>
											</div>
