			...
			<div class="content">
                ...
                <p class="confirm_msg_p">
                    <span style="text-align:center;color: #000;font-weight:bold;"><b>Appointment Details:</b></span>
                        <br>
                        Frank Geraghty<br>
                    Appointment 22/04/2018, 09:00 at 
                       
                    MedicSpot Clinic Isleworth
                        <br>
                        <br>
                    <span style="color: #ff585b;">Riverside Pharmacy</span>
                        <br>
                    1 Shrewsbury Walk, Isleworth TW7 7DE, United Kingdom
                        <br>
                        <br>
