...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Walk in GP Service Near Me - How it Works    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="">
    <meta name="description" content="Explanation of the process for seeing a GP near you on the same day. Learn more here.">
    ...
    <div class="container">
        <div class="page-header-wrapper">
            ...
            <nav class="nav-main">
                ...
                <a href="http://fixwebsupport.com/ambi/medicspot/how-it-works" class="active">How it works</a>
...
<page id="how-it-works">
	<section id="video" class="dots-background with-media">
		<div class="container">
			<div class="content">
				<h1>MedicSpot's Online GP Service</h1>
				<p>
				<!--__FUEL_MARKER__1-->Do you find it difficult to see an NHS GP that fits around your busy schedule? MedicSpot makes it simple and easy to get the care you need at a time and location convenient for you. Our online GP service is designed to give you quick and easy access to high-quality healthcare &ndash; no matter where you are or when you need it.				</p>
			</div>
		...
		<div class="container">
			...
			<section class="text-section">
				<div class="container">
					<div class="content">
						<p>
							<!--__FUEL_MARKER__2-->MedicSpot expertly manages more health issues than any other UK based online consultation service. The MedicSpot Clinical Station uses the latest advancements in medical technology to perform full clinical examinations. As NHS GPs, MedicSpot&rsquo;s founders recognise the importance of carrying out clinical examinations to ensure you receive the best possible care. This allows our doctors to safely and accurately diagnose your health issue to give you the correct treatment.						</p>
					</div>
				</div>
			</section>
