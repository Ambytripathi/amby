...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Walk In Centre Bradford - Same Day Private GP Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Walk In Centre Bradford">
    <meta name="description" content="Same day private GP appointments from our Medical Walk In Centre Bradford. MedicSpot's Walk In Service Bradford is conveniently located in Shearbridge inside Midnight Pharmacy. Skip the wait, select a time, and book a convenient private GP appointment.">
...
globals = { };
globals.lat = '53.7870434';
globals.lng = '-1.7741697';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Bradford Shearbridge</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To Visit Our Walk In Centre Bradford						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Bradford Shearbridge</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Bradford Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>354 Great Horton Rd, Bradford BD7 1QJ, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>01274 299185</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-clock-o" title="Opening Times"></i>
						<span>
							<strong>Opening Times</strong><br>
							<table cellpadding="10" cellspacing="10"><tr><td>Monday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Tuesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Wednesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Thursday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Friday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Saturday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Sunday:</td><td> 11:00 to 18:00 </td></tr></table>						</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-envelope" title="Email Address"></i>
						<span>
							<a href="mailto:shearbridge@medicspot.co.uk">shearbridge@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day private GP appointments from MedicSpot Clinic Bradford Shearbridge. Our Medical Walk In Centre Bradford is located inside Midnight Pharmacy. If you're looking for out of hours doctors in Bradford or a 'walk in clinic near me open today', our Walk In Centre Bradford opening times are 9am-6pm Monday-Saturday and 10am-6pm on Sunday. You no longer have to wait weeks for an appointment with your regular NHS GP - simply select a convenient time and day, book online, and visit our Walk In Centre Bradford.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:01274 299185" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Bradford.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Bradford_Consulting_Room.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Bradford_Clinical_Station.jpg)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Bradford GP Today</h1>
            <p>Visit our Bradford walk in centre to see a private GP</p>
