    ...
    <section class="logoHome" id="logos-qa" style="background-color:#F4F6F7">
        <div class="container">
            ...
            <div class="logos-list" style="border:2px solid #6D56EE;border-radius:10px">
                <img src="http://fixwebsupport.com/ambi/medicspot/assets/images/logo/logo-cqc.png" style="color:#6D56EE;">MedicSpot does not charge for issuing sick notes or referrals. If you are not fit for work or school, or need a specialist referral, your private GP will email this to you after the consultation.
            </div>
        </div>
    </section>
