	...
	<div class="booking-panel-table">
		...
		<div class="booking-panel-day-selector-wrapper">
			<ul class="booking-panel-day-selector">
				...
				<li class="active" data-date="23-04-2018" data-my-date="2018-04-23">TODAY</li>
	...
	function booking_Map() { 
		...
		// Add Markers.
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(16);
					booking_SelectEstablishment();
					getAppointmentTimes(16, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(17);
					booking_SelectEstablishment();
					getAppointmentTimes(17, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(18);
					booking_SelectEstablishment();
					getAppointmentTimes(18, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(21);
					booking_SelectEstablishment();
					getAppointmentTimes(21, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(22);
					booking_SelectEstablishment();
					getAppointmentTimes(22, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(23);
					booking_SelectEstablishment();
					getAppointmentTimes(23, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(24);
					booking_SelectEstablishment();
					getAppointmentTimes(24, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(25);
					booking_SelectEstablishment();
					getAppointmentTimes(25, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(26);
					booking_SelectEstablishment();
					getAppointmentTimes(26, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(28);
					booking_SelectEstablishment();
					getAppointmentTimes(28, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(29);
					booking_SelectEstablishment();
					getAppointmentTimes(29, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(30);
					booking_SelectEstablishment();
					getAppointmentTimes(30, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(31);
					booking_SelectEstablishment();
					getAppointmentTimes(31, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(32);
					booking_SelectEstablishment();
					getAppointmentTimes(32, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(33);
					booking_SelectEstablishment();
					getAppointmentTimes(33, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(34);
					booking_SelectEstablishment();
					getAppointmentTimes(34, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(35);
					booking_SelectEstablishment();
					getAppointmentTimes(35, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(36);
					booking_SelectEstablishment();
					getAppointmentTimes(36, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(37);
					booking_SelectEstablishment();
					getAppointmentTimes(37, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(38);
					booking_SelectEstablishment();
					getAppointmentTimes(38, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(39);
					booking_SelectEstablishment();
					getAppointmentTimes(39, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(40);
					booking_SelectEstablishment();
					getAppointmentTimes(40, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(41);
					booking_SelectEstablishment();
					getAppointmentTimes(41, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(42);
					booking_SelectEstablishment();
					getAppointmentTimes(42, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(43);
					booking_SelectEstablishment();
					getAppointmentTimes(43, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(44);
					booking_SelectEstablishment();
					getAppointmentTimes(44, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(45);
					booking_SelectEstablishment();
					getAppointmentTimes(45, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(46);
					booking_SelectEstablishment();
					getAppointmentTimes(46, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(47);
					booking_SelectEstablishment();
					getAppointmentTimes(47, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(48);
					booking_SelectEstablishment();
					getAppointmentTimes(48, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(49);
					booking_SelectEstablishment();
					getAppointmentTimes(49, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(50);
					booking_SelectEstablishment();
					getAppointmentTimes(50, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(51);
					booking_SelectEstablishment();
					getAppointmentTimes(51, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(52);
					booking_SelectEstablishment();
					getAppointmentTimes(52, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(53);
					booking_SelectEstablishment();
					getAppointmentTimes(53, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(54);
					booking_SelectEstablishment();
					getAppointmentTimes(54, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(55);
					booking_SelectEstablishment();
					getAppointmentTimes(55, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(56);
					booking_SelectEstablishment();
					getAppointmentTimes(56, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(57);
					booking_SelectEstablishment();
					getAppointmentTimes(57, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(58);
					booking_SelectEstablishment();
					getAppointmentTimes(58, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(59);
					booking_SelectEstablishment();
					getAppointmentTimes(59, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(61);
					booking_SelectEstablishment();
					getAppointmentTimes(61, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(62);
					booking_SelectEstablishment();
					getAppointmentTimes(62, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(63);
					booking_SelectEstablishment();
					getAppointmentTimes(63, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(65);
					booking_SelectEstablishment();
					getAppointmentTimes(65, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(66);
					booking_SelectEstablishment();
					getAppointmentTimes(66, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(67);
					booking_SelectEstablishment();
					getAppointmentTimes(67, '23-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(68);
					booking_SelectEstablishment();
					getAppointmentTimes(68, '23-04-2018');	
