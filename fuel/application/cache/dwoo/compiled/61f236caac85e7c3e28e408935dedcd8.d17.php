...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Holland Park GP Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Holland Park GP">
    <meta name="description" content="Same day Holland Park GP appointments for only £39. MedicSpot's Holland Park GP Walk In Centre is conveniently located on Holland Park Avenue inside Hillcrest Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.5069636';
globals.lng = '-0.2072609';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Holland Park</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A Holland Park GP						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Holland Park</p>
				</li>
				<li>
					...
					<h3>Visit Our Holland Park Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>106 Holland Park Ave, Holland Park, London W11 4UA, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3888</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:hollandpark@medicspot.co.uk">hollandpark@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day Holland Park GP appointments from Hillcrest Pharmacy. MedicSpot's Holland Park Surgery Address is 106 Holland Park Avenue. You can easily see a Holland Park GP using the Central line from Holland Park Underground Station (1-minute walk) or Overground services from Shepherd's Bush Station (11-minute walk). You no longer have to wait weeks for an appointment with your regular NHS GP. Book online to see a Holland Park GP instantly or contact our Holland Park Surgery email for any specific booking queries - hollandpark@medicspot.co.uk.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3888" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Holland_Park_GP_Clinic.JPG)" aria-label="MedicSpot Clinic Holland Park" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Holland_Park_GP_Clinic_Inside.JPG)" aria-label="MedicSpot Clinic Holland Park" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Holland_Park_GP_Clinic_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Holland Park" ></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Holland Park GP Today</h1>
            <p>Visit our Holland Park walk in centre to see a private GP</p>
