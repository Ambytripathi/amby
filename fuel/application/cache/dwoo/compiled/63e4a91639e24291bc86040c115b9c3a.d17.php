		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Euston.JPG)" aria-label="MedicSpot Clinic Euston" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Euston_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Euston" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Euston_Clinical_Station.JPG)" aria-label="MedicSpot Clinic Euston" ></div>
											</div>
