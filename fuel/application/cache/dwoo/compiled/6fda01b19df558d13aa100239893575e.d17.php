	...
	<div class="booking-panel-table">
		...
		<div class="booking-panel-day-selector-wrapper">
			<ul class="booking-panel-day-selector">
				...
				<li class="active" data-date="25-04-2018" data-my-date="2018-04-25">TODAY</li>
								<li class="day-appointments" data-date="26-04-2018" data-clinicId="" data-my-date="2018-04-26">Thu<br>26th Apr</li>
								<li class="day-appointments" data-date="27-04-2018" data-clinicId="" data-my-date="2018-04-27">Fri<br>27th Apr</li>
								<li class="day-appointments" data-date="28-04-2018" data-clinicId="" data-my-date="2018-04-28">Sat<br>28th Apr</li>
	...
	function booking_Map() { 
		...
		// Add Markers.
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(16);
					booking_SelectEstablishment();
					getAppointmentTimes(16, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(17);
					booking_SelectEstablishment();
					getAppointmentTimes(17, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(18);
					booking_SelectEstablishment();
					getAppointmentTimes(18, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(21);
					booking_SelectEstablishment();
					getAppointmentTimes(21, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(22);
					booking_SelectEstablishment();
					getAppointmentTimes(22, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(23);
					booking_SelectEstablishment();
					getAppointmentTimes(23, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(24);
					booking_SelectEstablishment();
					getAppointmentTimes(24, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(25);
					booking_SelectEstablishment();
					getAppointmentTimes(25, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(26);
					booking_SelectEstablishment();
					getAppointmentTimes(26, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(28);
					booking_SelectEstablishment();
					getAppointmentTimes(28, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(29);
					booking_SelectEstablishment();
					getAppointmentTimes(29, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(30);
					booking_SelectEstablishment();
					getAppointmentTimes(30, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(31);
					booking_SelectEstablishment();
					getAppointmentTimes(31, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(32);
					booking_SelectEstablishment();
					getAppointmentTimes(32, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(33);
					booking_SelectEstablishment();
					getAppointmentTimes(33, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(34);
					booking_SelectEstablishment();
					getAppointmentTimes(34, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(35);
					booking_SelectEstablishment();
					getAppointmentTimes(35, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(36);
					booking_SelectEstablishment();
					getAppointmentTimes(36, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(37);
					booking_SelectEstablishment();
					getAppointmentTimes(37, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(38);
					booking_SelectEstablishment();
					getAppointmentTimes(38, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(39);
					booking_SelectEstablishment();
					getAppointmentTimes(39, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(40);
					booking_SelectEstablishment();
					getAppointmentTimes(40, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(41);
					booking_SelectEstablishment();
					getAppointmentTimes(41, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(42);
					booking_SelectEstablishment();
					getAppointmentTimes(42, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(43);
					booking_SelectEstablishment();
					getAppointmentTimes(43, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(44);
					booking_SelectEstablishment();
					getAppointmentTimes(44, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(45);
					booking_SelectEstablishment();
					getAppointmentTimes(45, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(46);
					booking_SelectEstablishment();
					getAppointmentTimes(46, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(47);
					booking_SelectEstablishment();
					getAppointmentTimes(47, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(48);
					booking_SelectEstablishment();
					getAppointmentTimes(48, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(49);
					booking_SelectEstablishment();
					getAppointmentTimes(49, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(50);
					booking_SelectEstablishment();
					getAppointmentTimes(50, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(51);
					booking_SelectEstablishment();
					getAppointmentTimes(51, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(52);
					booking_SelectEstablishment();
					getAppointmentTimes(52, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(53);
					booking_SelectEstablishment();
					getAppointmentTimes(53, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(54);
					booking_SelectEstablishment();
					getAppointmentTimes(54, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(55);
					booking_SelectEstablishment();
					getAppointmentTimes(55, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(56);
					booking_SelectEstablishment();
					getAppointmentTimes(56, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(57);
					booking_SelectEstablishment();
					getAppointmentTimes(57, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(58);
					booking_SelectEstablishment();
					getAppointmentTimes(58, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(59);
					booking_SelectEstablishment();
					getAppointmentTimes(59, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(61);
					booking_SelectEstablishment();
					getAppointmentTimes(61, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(62);
					booking_SelectEstablishment();
					getAppointmentTimes(62, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(63);
					booking_SelectEstablishment();
					getAppointmentTimes(63, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(65);
					booking_SelectEstablishment();
					getAppointmentTimes(65, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(66);
					booking_SelectEstablishment();
					getAppointmentTimes(66, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(67);
					booking_SelectEstablishment();
					getAppointmentTimes(67, '25-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(68);
					booking_SelectEstablishment();
					getAppointmentTimes(68, '25-04-2018');	
