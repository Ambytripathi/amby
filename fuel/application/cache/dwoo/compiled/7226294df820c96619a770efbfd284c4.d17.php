...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Private GP Services | Book Same Day Private GP Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Private GP">
    <meta name="description" content="Book same day private GP appointments using our GP near me tool. Our expert private doctors help with prescriptions, sick notes, and referrals and use diagnostic equipment for comprehensive clinical examinations. Private GP services are available from 45+ GP practices nationwide including 30+ London GP clinics.">
...
<link rel="stylesheet" href="http://fixwebsupport.com/ambi/medicspot/assets/css/ladda-themeless.min.css">
<script src="http://fixwebsupport.com/ambi/medicspot/assets/js/spin.min.js"></script>
<script src="http://fixwebsupport.com/ambi/medicspot/assets/js/ladda.min.js"></script>
...
<div id="booking-panel">
	...
	<div class="booking-panel-table">
		...
		<div class="booking-panel-day-selector-wrapper">
			<ul class="booking-panel-day-selector">
				...
				<li class="active" data-date="28-04-2018" data-my-date="2018-04-28">TODAY</li>
								<li class="day-appointments" data-date="29-04-2018" data-clinicId="" data-my-date="2018-04-29">Sun<br>29th Apr</li>
								<li class="day-appointments" data-date="30-04-2018" data-clinicId="" data-my-date="2018-04-30">Mon<br>30th Apr</li>
								<li class="day-appointments" data-date="01-05-2018" data-clinicId="" data-my-date="2018-05-01">Tue<br>1st May</li>
								<li class="day-appointments" data-date="02-05-2018" data-clinicId="" data-my-date="2018-05-02">Wed<br>2nd May</li>
								<li class="day-appointments" data-date="03-05-2018" data-clinicId="" data-my-date="2018-05-03">Thu<br>3rd May</li>
							</ul>
		</div>		
			<img style="display: none;height: 200px; position: absolute; left: 135px; margin-top: 89px;" id="booking-loader" src="http://fixwebsupport.com/ambi/medicspot/assets/img/loading.gif" alt="Circular loading gif" >		
	...
	<div class="booking-form" style="display:none;">
		<div class="frame-content " style="max-height: 308px;margin-bottom: 5px;">
			<img style="display: none;" id="confirm-loader" src="http://fixwebsupport.com/ambi/medicspot/assets/img/loading.gif" alt="Circular loading gif" >
				<div class="row">
                            ...
                            <div class="form-group form-padding" style="text-align: left;">
                            	...
                            	<tr>
                            		...
                            		<td>
                            			<label class="control-label">I accept the <a href="http://fixwebsupport.com/ambi/medicspot/terms">Terms and Conditions</a> (no under 5's)</label>
                            		</td>
                            	</tr>
                            	</table>
                            </div>
		...
		<div class="booking-input">
			<div class="booking-details-row">
				...
				<div class="details-search">
					<i id="iconBtn" class="fa fa-search"></i>
				</div>
			</div>
...
$( document ).ready(function() { 
	...
	$('body').on('keyup', '#postcode_search', function(){ 	
		if($('#postcode_search').val().length>=2){ 			
			$.ajax({ 
				type: "POST",
				url: 'http://fixwebsupport.com/ambi/medicspot/Clinic_search/postcode_search',
				data: { 'postcode':jQuery('#postcode_search').val(), 'ci_csrf_token':''},
				dataType:'html',
	...
	$('#confirm').on('click', function(){ 	
		...
		if(clinic_id < 1){ 
			...
			$.ajax({ 
				type: "POST",
				url: 'http://fixwebsupport.com/ambi/medicspot/index.php/appointments/ajax_register_appointment',
				data: { 
				...
				{ 	
					...
					if(data.status==0){ 
						...
						window.location.href="http://fixwebsupport.com/ambi/medicspot/booking_confirm";
					}
				}
			});
		}
	...
	$('.booking-input input').click(function () { 
		...
		$.ajax({ 
			type: "POST",
			url: 'http://fixwebsupport.com/ambi/medicspot/Clinic_search/search',
			data: $("#booking-form").serialize()+'&ci_csrf_token=', 
			dataType:'html',
			success: function(data)
			{ 	
				$('.booking-suggestions').html(data);
	...
	$('body').on('click', '.suggestion', function(){ 
		...
		navigator.geolocation.getCurrentPosition(function(position) { 
			...
			var destLon = globals.lng;
		 	var image = 'http://fixwebsupport.com/ambi/medicspot/assets/images/clinic.png';
			...
			var image_start = 'http://fixwebsupport.com/ambi/medicspot/assets/images/clinic_start.png';
			var marker = new google.maps.Marker({ 				
...
function loadClinicData(clinic_id, distance){ 
	...
	$.ajax({ 
			type: "POST",
			url: 'http://fixwebsupport.com/ambi/medicspot/Clinic_search/clinic_data',
			data: { 'ci_csrf_token': '' ,'clinic_id':clinic_id},
			dataType:'json',
			success: function(data)
			{ 	
			...
			var marker = new google.maps.Marker({ 				
				...
				if(data.url!=''){ 
					...
					jQuery('#www_span').html('<a href="http://fixwebsupport.com/ambi/medicspot/clinics/'+url+'/">More Details</a>');
				}else{ 
					jQuery('#www_span').html('<a href="http://fixwebsupport.com/ambi/medicspot/establishment/'+data.clinic_id+'">More Details</a>');	
				}
				

				if(data.image1!=''){ 
					jQuery('.photo1').attr('style',"background-image:url(http://fixwebsupport.com/ambi/medicspot/assets/images/"+data.image1+");");
				}
				if(data.image2!=''){ 
					jQuery('.photo2').attr('style',"background-image:url(http://fixwebsupport.com/ambi/medicspot/assets/images/"+data.image2+");");
				}
				if(data.image3!=''){ 
					jQuery('.photo3').attr('style',"background-image:url(http://fixwebsupport.com/ambi/medicspot/assets/images/"+data.image3+");");
				}
			}
	});
}
...
function getAppointmentTimes(clinic_id, date){ 
	...
	$.ajax({ 
			type: "POST",
			url: 'http://fixwebsupport.com/ambi/medicspot/index.php/appointments/ajax_get_available_hours',
			data: { 'service_id':13, 'provider_id':'any-provider', 'selected_date':date, 'service_duration':service_duration, 'manage_mode':false, 'ci_csrf_token': '' ,'clinic_id':clinic_id},
			dataType:'json',
			success: function(data)
			{ 	
			$('#booking-loader').hide();			
...
$( document ).ready(function(){ 
    ...
    <section id="steps" class="steps howWeHelpYou">
        <div class="container">
            ...
            <p class="help_description">MedicSpot makes it simple and easy to get the care you need – no matter where you are or when you need it. We answer your search for “private GP london” or “private GP near me” with 50+ pharmacy <a href="http://fixwebsupport.com/ambi/medicspot/our-clinics">walk in centres.</a> Our nationwide coverage gives you convenient access to private GPs so you never have to wait for healthcare again.</p>
            <ul class="steps-list">
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/medicspot/assets/images/icons/clock.png" alt="White clock icon on MedicSpot purple background">
                ...
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/medicspot/assets/images/icons/stethoscope.png" alt="White stethoscope icon on MedicSpot purple background" >
                ...
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/medicspot/assets/images/icons/documentapprove.png" alt="White clipboard icon with check mark on MedicSpot purple background" >
            ...
            <a href="http://fixwebsupport.com/ambi/medicspot/what-we-treat" class="btn s-large newsecbtn">What we treat</a>
        </div>
    </section>
    <section id="steps" class="steps threeSteps" style="background-color:#F4F6F7">
        <div class="container">
            ...
            <ul class="steps-list">
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/medicspot/assets/images/icons/Private-GP-Near-Me-Icon.png" alt="Map with a location marker and the MedicSpot logo to illustrate the short distance to your nearest private GP">
                    <h3>Book Online</h3>
                    <p class="margintop">Book a convenient same day private GP appointment.</p>
                </li>
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/medicspot/assets/images/icons/Online-Doctor.png" alt="Illustration of an online doctor with a stethoscope draped over the doctor's shoulders"  >
                ...
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/medicspot/assets/images/icons/Prescription.png" alt=" Illustration of two antibiotics and your prescription" >
        ...
        <div class="container">
            ...
            <ul class="steps-list">
                <li style="box-shadow:none !important;">
                    <img class="step-icon" src="https://www.medicspot.co.uk/assets/images/trevor2.png" alt="White clock icon on MedicSpot purple background">
                ...
                <li style="box-shadow:none !important;">
                    <img class="step-icon" src="https://www.medicspot.co.uk/assets/images/trevor2.png" alt="White stethoscope icon on MedicSpot purple background" >
                ...
                <li style="box-shadow:none !important;">
                    <img class="step-icon" src="https://www.medicspot.co.uk/assets/images/trevor2.png" alt="White clipboard icon with check mark on MedicSpot purple background" >
    ...
    <section id="logos-media">
        <div class="container">
            ...
            <div class="logos-list">
                <img src="http://fixwebsupport.com/ambi/medicspot/assets/images/logo/logo-bbc.png" title="BBC" alt="BBC logo" >
                <img src="http://fixwebsupport.com/ambi/medicspot/assets/images/logo/logo-metro.png" title="Metro" alt="Metro logo" >
                <img src="http://fixwebsupport.com/ambi/medicspot/assets/images/logo/logo-pj.png" title="The Pharmaceutical Journal" tag="The Pharmaceutical Journal logo" >
                <img src="http://fixwebsupport.com/ambi/medicspot/assets/images/logo/logo-et.png" title="Evening Times" alt="Evening Times logo" >
                <img src="http://fixwebsupport.com/ambi/medicspot/assets/images/logo/logo-pulse.png" title="Pulse" alt="Pulse logo" >
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="testimonials-quotes testimonials-slicky" id="slickySlidertext">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://fixwebsupport.com/ambi/medicspot/assets/images/Jacqueline.png">
                                <div class="testimony-name">Jacqueline</div>
                            </footer>
                        </blockquote>
                    </div>
                                    <div>
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://fixwebsupport.com/ambi/medicspot/assets/images/kelly2.png">
                                <div class="testimony-name">Kelly</div>
                            </footer>
                        </blockquote>
                    </div>
                                    <div>
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://fixwebsupport.com/ambi/medicspot/assets/images/trevor2.png">
                                <div class="testimony-name">Trevor</div>
                            </footer>
                        </blockquote>
                    </div>
                                    <div>
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://fixwebsupport.com/ambi/medicspot/assets/images/michael2.png">
                                <div class="testimony-name">Michael</div>
                            </footer>
                        </blockquote>
                    </div>
                                    <div>
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://fixwebsupport.com/ambi/medicspot/assets/images/nolan2.png">
                                <div class="testimony-name">Nolan</div>
                            </footer>
                        </blockquote>
                    </div>
...
<p>Filename: _layouts/main.php</p>
<p>Line Number: 202</p>
	...
	<p>Backtrace:</p>
			...
			File: /home1/fixwebsi/public_html/ambi/medicspot/fuel/application/views/_layouts/main.php<br />
			Line: 202<br />
			...
			<p style="margin-left:10px">
			File: /home1/fixwebsi/public_html/ambi/medicspot/fuel/modules/fuel/core/Loader.php<br />
			Line: 396<br />
			Function: include			</p>
			...
			<p style="margin-left:10px">
			File: /home1/fixwebsi/public_html/ambi/medicspot/fuel/modules/fuel/libraries/Fuel_pages.php<br />
			Line: 824<br />
			...
			<p style="margin-left:10px">
			File: /home1/fixwebsi/public_html/ambi/medicspot/fuel/modules/fuel/controllers/Page_router.php<br />
			Line: 119<br />
			...
			<p style="margin-left:10px">
			File: /home1/fixwebsi/public_html/ambi/medicspot/index.php<br />
			Line: 364<br />
...
<p>Line Number: 202</p>
	...
	<p>Backtrace:</p>
			...
			<div class="content">
				<dl class="faq-list">
										<dt>What is MedicSpot?</dt>
					<dd>
						MedicSpot allows you to see one of our online GP&rsquo;s from the comfort of your pharmacy&rsquo;s private consulting room via video-link (like over Skype or FaceTime). You will be able to see one of our doctors in a matter of minutes without even needing to make an appointment. With MedicSpot you can finally fit your doctor visits around your timetable!					</dd>
										<dt>Is There A Cost For This?</dt>
					<dd>
						MedicSpot is a private GP service and hence there is a &pound;39 fee per consultation. Your consultation will typically last 10-15 minutes, but we don&rsquo;t charge extra if we take longer in dealing with your health complaint. We have kept our fees deliberately affordable as we recognise that we can help many more patients like you by giving them a safe, affordable and convenient alternative to their NHS GP surgery. Any medication that your MedicSpot doctor recommends will be issued as a paid-for private prescription that will be ready for collection on the way out.					</dd>
										<dt>What Can MedicSpot Help With?</dt>
					<dd>
						MedicSpot can successfully complete 95% of consultations.  In addition to providing diagnosis, treatment and prescriptions; MedicSpot can also issue sick notes, referral letters and general healthcare advice.					</dd>
										<dt>What happens if the doctor needs to examine me?</dt>
					<dd>
						Our state-of-the-art MedicSpot Clinical Station allow the doctor to perform various examinations on you just as your normal GP would do. The doctor will guide you what you need to do, but a pharmacy staff member is always available to give you a helping hand if needed.					</dd>
										<dt>Who are your doctors?</dt>
					<dd>
						All of our doctors are hand-picked UK based General Practitioners (GP&rsquo;s) registered and regulated by the General Medical Council. In addition, MedicSpot is registered and regulated by the Care Quality Commission to ensure we meet the fundamental standards of safe and quality healthcare provision in the UK.  You can find out more about our doctors by going to the about us page.					</dd>
										<dt>Shall I tell my regular GP that I used MedicSpot?</dt>
					<dd>
						At the start of each consultation, you will be asked whether you want a copy of your records to go to your normal NHS GP.  We encourage this to promote better continuity of care, but the decision is ultimately up to you.  

MedicSpot is designed to be used in addition to your normal GP, not as a substitute.					</dd>
										<dt>Can I use MedicSpot if I am not a resident of the UK?</dt>
					<dd>
						Yes, MedicSpot can be used by anyone, even if they are visiting the UK temporarily as tourist.  We also see many patients who have moved to the UK, but who have not yet been able to register with a NHS GP.					</dd>
										<dt>What conditions is MedicSpot not suitable for?</dt>
					<dd>
						It is important to know that MedicSpot is not an emergency medical service and you should contact your local emergency services or attend accident & emergency if you feel that your condition is an emergency.  These include things such as suspected heart attack or severe chest pain, neurological deficit or suspected stroke or seizures, severe or heavy bleeding, severe or sudden onset of pain, severe mental health issues such as thoughts of self harm, suicide or psychosis, pregnancy related complications, major trauma on any part of the body or unrelenting high fever.					</dd>
										<dt>Do I need to buy my prescription from the same pharmacy I've used MedicSpot from?</dt>
					<dd>
						Whilst the vast majority of our patients get the prescription from the MedicSpot pharmacy, you are well within your rights to take your prescription to any other pharmacy. Just let the pharmacist know and you will be told on how to do this. It&rsquo;s simple!					</dd>
										<dt>How can I provide feedback?</dt>
					<dd>
						We really encourage all types of feedback so we can continue to improve our service.  You can leave a comment at the end of your consultation, leave a Google review or simply by contacting us via email or phone.					</dd>
										<dt>How is MedicSpot different from other doctor apps?</dt>
					<dd>
						As doctors, we recognise that examination equipment is needed to safely diagnose and treat many conditions which a video-chat only doctor cannot do.  Doctors can treat you more safely and effectively if they have the ability to examine you.					</dd>
									</dl>
			</div>
		</div>
	</section>
    <section id="call-to-action" class="call-to-action">
        <div class="container">
            ...
            <a href="http://fixwebsupport.com/ambi/medicspot/our-clinics" class="btn s-large s-rounded s-inverted">Book now</a>
...
<script language="javascript">
    ...
    function booking_Map() {  
        ...
        markerIcon = new google.maps.MarkerImage(
            'http://fixwebsupport.com/ambi/medicspot/assets/images/map-marker.png',
            ...
            new google.maps.Size(32, 32)
					...
					position: { 
						lat: parseFloat(51.55285),
						lng: parseFloat(-0.210386)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(16);
					booking_SelectEstablishment();
					getAppointmentTimes(16, '28-04-2018');	
				...
				markerArray[16] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.5266968),
						lng: parseFloat(-0.1384472)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(17);
					booking_SelectEstablishment();
					getAppointmentTimes(17, '28-04-2018');	
				...
				markerArray[17] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.5058975),
						lng: parseFloat(-0.2277367)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(18);
					booking_SelectEstablishment();
					getAppointmentTimes(18, '28-04-2018');	
				...
				markerArray[18] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.5801908),
						lng: parseFloat(-0.3353198)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(21);
					booking_SelectEstablishment();
					getAppointmentTimes(21, '28-04-2018');	
				...
				markerArray[21] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.508147),
						lng: parseFloat(-0.1057661)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(22);
					booking_SelectEstablishment();
					getAppointmentTimes(22, '28-04-2018');	
				...
				markerArray[22] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.545105),
						lng: parseFloat(-0.103492)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(23);
					booking_SelectEstablishment();
					getAppointmentTimes(23, '28-04-2018');	
				...
				markerArray[23] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.5227623),
						lng: parseFloat(-0.097654)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(24);
					booking_SelectEstablishment();
					getAppointmentTimes(24, '28-04-2018');	
				...
				markerArray[24] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.5172603),
						lng: parseFloat(-0.1723911)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(25);
					booking_SelectEstablishment();
					getAppointmentTimes(25, '28-04-2018');	
				...
				markerArray[25] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.4920293),
						lng: parseFloat(-0.192987)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(26);
					booking_SelectEstablishment();
					getAppointmentTimes(26, '28-04-2018');	
				...
				markerArray[26] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(55.859139),
						lng: parseFloat(-4.240898)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(28);
					booking_SelectEstablishment();
					getAppointmentTimes(28, '28-04-2018');	
				...
				markerArray[28] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.548275),
						lng: parseFloat(-0.221969)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(29);
					booking_SelectEstablishment();
					getAppointmentTimes(29, '28-04-2018');	
				...
				markerArray[29] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.509462),
						lng: parseFloat(-0.196981)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(30);
					booking_SelectEstablishment();
					getAppointmentTimes(30, '28-04-2018');	
				...
				markerArray[30] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.4941275),
						lng: parseFloat(-0.1740792)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(31);
					booking_SelectEstablishment();
					getAppointmentTimes(31, '28-04-2018');	
				...
				markerArray[31] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.4682881),
						lng: parseFloat(-0.325005)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(32);
					booking_SelectEstablishment();
					getAppointmentTimes(32, '28-04-2018');	
				...
				markerArray[32] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.506445),
						lng: parseFloat(-0.146193)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(33);
					booking_SelectEstablishment();
					getAppointmentTimes(33, '28-04-2018');	
				...
				markerArray[33] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.4642822),
						lng: parseFloat(-0.1310743)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(34);
					booking_SelectEstablishment();
					getAppointmentTimes(34, '28-04-2018');	
				...
				markerArray[34] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.493434),
						lng: parseFloat(-0.175115)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(35);
					booking_SelectEstablishment();
					getAppointmentTimes(35, '28-04-2018');	
				...
				markerArray[35] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.496723),
						lng: parseFloat(-0.082512)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(36);
					booking_SelectEstablishment();
					getAppointmentTimes(36, '28-04-2018');	
				...
				markerArray[36] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.471922),
						lng: parseFloat(-0.122539)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(37);
					booking_SelectEstablishment();
					getAppointmentTimes(37, '28-04-2018');	
				...
				markerArray[37] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.4957),
						lng: parseFloat(-0.101953)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(38);
					booking_SelectEstablishment();
					getAppointmentTimes(38, '28-04-2018');	
				...
				markerArray[38] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.481725),
						lng: parseFloat(-0.180568)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(39);
					booking_SelectEstablishment();
					getAppointmentTimes(39, '28-04-2018');	
				...
				markerArray[39] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.5461186),
						lng: parseFloat(-0.1620878)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(40);
					booking_SelectEstablishment();
					getAppointmentTimes(40, '28-04-2018');	
				...
				markerArray[40] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.491989),
						lng: parseFloat(-0.140335)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(41);
					booking_SelectEstablishment();
					getAppointmentTimes(41, '28-04-2018');	
				...
				markerArray[41] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.499493),
						lng: parseFloat(-0.196697)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(42);
					booking_SelectEstablishment();
					getAppointmentTimes(42, '28-04-2018');	
				...
				markerArray[42] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.460847),
						lng: parseFloat(-0.163174)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(43);
					booking_SelectEstablishment();
					getAppointmentTimes(43, '28-04-2018');	
				...
				markerArray[43] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.51643),
						lng: parseFloat(-0.205142)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(44);
					booking_SelectEstablishment();
					getAppointmentTimes(44, '28-04-2018');	
				...
				markerArray[44] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.761082),
						lng: parseFloat(-0.566014)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(45);
					booking_SelectEstablishment();
					getAppointmentTimes(45, '28-04-2018');	
				...
				markerArray[45] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.5069636),
						lng: parseFloat(-0.2072609)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(46);
					booking_SelectEstablishment();
					getAppointmentTimes(46, '28-04-2018');	
				...
				markerArray[46] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.5097839),
						lng: parseFloat(-0.1516887)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(47);
					booking_SelectEstablishment();
					getAppointmentTimes(47, '28-04-2018');	
				...
				markerArray[47] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(52.200338),
						lng: parseFloat(0.120241)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(48);
					booking_SelectEstablishment();
					getAppointmentTimes(48, '28-04-2018');	
				...
				markerArray[48] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(55.942144),
						lng: parseFloat(-3.181826)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(49);
					booking_SelectEstablishment();
					getAppointmentTimes(49, '28-04-2018');	
				...
				markerArray[49] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.464049),
						lng: parseFloat(-2.570454)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(50);
					booking_SelectEstablishment();
					getAppointmentTimes(50, '28-04-2018');	
				...
				markerArray[50] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.4906826),
						lng: parseFloat(0.0696306)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(51);
					booking_SelectEstablishment();
					getAppointmentTimes(51, '28-04-2018');	
				...
				markerArray[51] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(53.8122103),
						lng: parseFloat(-1.5216806)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(52);
					booking_SelectEstablishment();
					getAppointmentTimes(52, '28-04-2018');	
				...
				markerArray[52] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(52.9606923),
						lng: parseFloat(-1.1691743)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(53);
					booking_SelectEstablishment();
					getAppointmentTimes(53, '28-04-2018');	
				...
				markerArray[53] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(53.7870434),
						lng: parseFloat(-1.7741697)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(54);
					booking_SelectEstablishment();
					getAppointmentTimes(54, '28-04-2018');	
				...
				markerArray[54] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(53.3873755),
						lng: parseFloat(-1.4621793)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(55);
					booking_SelectEstablishment();
					getAppointmentTimes(55, '28-04-2018');	
				...
				markerArray[55] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.5568368),
						lng: parseFloat(-0.1386816)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(56);
					booking_SelectEstablishment();
					getAppointmentTimes(56, '28-04-2018');	
				...
				markerArray[56] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(55.753366),
						lng: parseFloat(-4.184255)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(57);
					booking_SelectEstablishment();
					getAppointmentTimes(57, '28-04-2018');	
				...
				markerArray[57] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.4963255),
						lng: parseFloat(-0.1472679)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(58);
					booking_SelectEstablishment();
					getAppointmentTimes(58, '28-04-2018');	
				...
				markerArray[58] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.5322723),
						lng: parseFloat(-0.1694315)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(59);
					booking_SelectEstablishment();
					getAppointmentTimes(59, '28-04-2018');	
				...
				markerArray[59] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.7524636),
						lng: parseFloat(-1.2775974999999562)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(61);
					booking_SelectEstablishment();
					getAppointmentTimes(61, '28-04-2018');	
				...
				markerArray[61] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(56.4603594),
						lng: parseFloat(-2.9935841)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(62);
					booking_SelectEstablishment();
					getAppointmentTimes(62, '28-04-2018');	
				...
				markerArray[62] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.537667),
						lng: parseFloat(-0.184479)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(63);
					booking_SelectEstablishment();
					getAppointmentTimes(63, '28-04-2018');	
				...
				markerArray[63] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.514655),
						lng: parseFloat(-0.166613)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(65);
					booking_SelectEstablishment();
					getAppointmentTimes(65, '28-04-2018');	
				...
				markerArray[65] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.415159),
						lng: parseFloat(0.795122)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(66);
					booking_SelectEstablishment();
					getAppointmentTimes(66, '28-04-2018');	
				...
				markerArray[66] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.892541),
						lng: parseFloat(-0.430155)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(67);
					booking_SelectEstablishment();
					getAppointmentTimes(67, '28-04-2018');	
				...
				markerArray[67] = marker;
								marker = new google.maps.Marker({ 
					position: { 
						lat: parseFloat(51.9952375),
						lng: parseFloat(-0.7278389)
					},
					icon: markerIcon,
					map: map
				});
				marker.addListener('click', function() { 
					...
					loadClinicData(68);
					booking_SelectEstablishment();
					getAppointmentTimes(68, '28-04-2018');	
