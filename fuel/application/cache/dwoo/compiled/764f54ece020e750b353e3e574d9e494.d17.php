		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Pimlico_GP_Clinic.JPG)" aria-label="MedicSpot Clinic Pimlico" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Pimlico_GP_Clinic_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Pimlico" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Pimlico_GP_Clinic_Medical_Station.JPG)" aria-label="MedicSpot Clinic Pimlico" ></div>
											</div>
