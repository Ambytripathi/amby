		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Victoria_Clinic.JPG)" aria-label="MedicSpot Clinic Victoria" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Victoria_Clinic_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Victoria" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Victoria_Clinic_Consultation_Room.JPG)" aria-label="MedicSpot Clinic Victoria" ></div>
											</div>
