...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/medic/assets/css/site.normalize.css">
    <link rel="stylesheet" href="http://localhost/medic/assets/css/custom.css">
    <link rel="stylesheet" href="http://localhost/medic/assets/css/site.booking.css">
    ...
    <link rel="stylesheet" href="http://localhost/medic/assets/css/slick.css"/>
    ...
    <script src="http://localhost/medic/assets/js/site.main.js" defer></script>
    <script src="http://localhost/medic/assets/js/moment-with-locales.js"></script>
...
<script>
    (function(h,o,t,j,a,r){ 
        ...
        <script src="//ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script><script>window.jQuery || document.write('<script src="/medic/assets/js/jquery.js?c="><\/script>');</script>
    <script>
...
<header id="page-header">
    <div class="container">
        <div class="page-header-wrapper">
            <a href="http://localhost/medic/" class="page-logo" title="Medicspot" style="background: url('http://localhost/medic/assets/images/logo-ms.png');    background-size: 15.2rem 4.8rem;">Medicspot</a>
            <nav class="nav-main">
                ...
                <a href="http://localhost/medic/pricing" >Pricing</a>
                <a href="http://localhost/medic/how-it-works" >How it works</a>
                <a href="http://localhost/medic/our-clinics"  class="btn bokNowbtn">Book Now</a>
...
<div id="NEEDHELP_MODEL" class="modal">
  <div class="modal-content">
    ...
    <div class="block one">
        <img src="http://localhost/medic/assets/images/client_msg.png" alt="Chat with MedicSpot icon" />
        <a href="javascript:void(0);" onclick="openChat();return false;" class="btn chatteam" id="chatteam">Chat With Our Team</a>
    </div>
    <div class="block two">
        <img src="http://localhost/medic/assets/images/client_email.png" alt="Call MedicSpot icon" />
        <a href="mailto:info@medicspot.co.uk" class="btn">info@medicspot.co.uk</a>
    </div>
    <div class="block three">
        <img src="http://localhost/medic/assets/images/client_call.png" alt="Call MedicSpot icon" />
...
<link rel="stylesheet" href="http://localhost/medic/assets/css/ladda-themeless.min.css">
<script src="http://localhost/medic/assets/js/spin.min.js"></script>
<script src="http://localhost/medic/assets/js/ladda.min.js"></script>
...
<div id="booking-panel">
	...
	<div class="booking-panel-table">
		...
		<div class="booking-panel-day-selector-wrapper">
			<ul class="booking-panel-day-selector">
				...
				<li class="active" data-date="26-04-2018" data-my-date="2018-04-26">TODAY</li>
			...
			<img style="display: none;height: 200px; position: absolute; left: 135px; margin-top: 89px;" id="booking-loader" src="http://localhost/medic/assets/img/loading.gif" alt="Circular loading gif" >		
	...
	<div class="booking-form" style="display:none;">
		<div class="frame-content " style="max-height: 308px;margin-bottom: 5px;">
			<img style="display: none;" id="confirm-loader" src="http://localhost/medic/assets/img/loading.gif" alt="Circular loading gif" >
				<div class="row">
                            ...
                            <div class="form-group form-padding" style="text-align: left;">
                            	...
                            	<tr>
                            		...
                            		<td>
                            			<label class="control-label">I accept the <a href="http://localhost/medic/terms">Terms and Conditions</a> (no under 5's)</label>
                            		</td>
                            	</tr>
                            	</table>
                            </div>
...
$( document ).ready(function() { 
	...
	$('body').on('keyup', '#postcode_search', function(){ 	
		if($('#postcode_search').val().length>=2){ 			
			$.ajax({ 
				type: "POST",
				url: 'http://localhost/medic/Clinic_search/postcode_search',
	...
	$('#confirm').on('click', function(){ 	
		...
		if(clinic_id < 1){ 
			...
			$.ajax({ 
				type: "POST",
				url: 'http://localhost/medic/index.php/appointments/ajax_register_appointment',
				data: { 
				...
				{ 	
					...
					if(data.status==0){ 
						...
						window.location.href="http://localhost/medic/booking_confirm";
					}
				}
			});
		}
	...
	$('.booking-input input').click(function () { 
		...
		$.ajax({ 
			type: "POST",
			url: 'http://localhost/medic/Clinic_search/search',
	...
	$('body').on('click', '.suggestion', function(){ 
		...
		getAppointmentTimes(clinic_id, '26-04-2018');	
		...
		navigator.geolocation.getCurrentPosition(function(position) { 
			...
			var destLon = globals.lng;
		 	var image = 'http://localhost/medic/assets/images/clinic.png';
			...
			var image_start = 'http://localhost/medic/assets/images/clinic_start.png';
			var marker = new google.maps.Marker({ 				
...
function loadClinicData(clinic_id, distance){ 
	...
	$.ajax({ 
			type: "POST",
			url: 'http://localhost/medic/Clinic_search/clinic_data',
			...
			var marker = new google.maps.Marker({ 				
				...
				if(data.url!=''){ 
					...
					jQuery('#www_span').html('<a href="http://localhost/medic/clinics/'+url+'/">More Details</a>');
				}else{ 
					jQuery('#www_span').html('<a href="http://localhost/medic/establishment/'+data.clinic_id+'">More Details</a>');	
				}
				

				if(data.image1!=''){ 
					jQuery('.photo1').attr('style',"background-image:url(http://localhost/medic/assets/images/"+data.image1+");");
				}
				if(data.image2!=''){ 
					jQuery('.photo2').attr('style',"background-image:url(http://localhost/medic/assets/images/"+data.image2+");");
				}
				if(data.image3!=''){ 
					jQuery('.photo3').attr('style',"background-image:url(http://localhost/medic/assets/images/"+data.image3+");");
				}
			}
	});
}
...
function getAppointmentTimes(clinic_id, date){ 
	...
	$.ajax({ 
			type: "POST",
			url: 'http://localhost/medic/index.php/appointments/ajax_get_available_hours',
...
$( document ).ready(function(){ 
    ...
    <section id="steps" class="steps howWeHelpYou">
        <div class="container">
            ...
            <p class="help_description">MedicSpot makes it simple and easy to get the care you need – no matter where you are or when you need it. We answer your search for “private GP london” or “private GP near me” with 50+ pharmacy <a href="http://localhost/medic/our-clinics">walk in centres.</a> Our nationwide coverage gives you convenient access to private GPs so you never have to wait for healthcare again.</p>
            <ul class="steps-list">
                <li>
                    <img class="step-icon" src="http://localhost/medic/assets/images/icons/clock.png" alt="White clock icon on MedicSpot purple background">
                ...
                <li>
                    <img class="step-icon" src="http://localhost/medic/assets/images/icons/stethoscope.png" alt="White stethoscope icon on MedicSpot purple background" >
                ...
                <li>
                    <img class="step-icon" src="http://localhost/medic/assets/images/icons/documentapprove.png" alt="White clipboard icon with check mark on MedicSpot purple background" >
            ...
            <a href="http://localhost/medic/what-we-treat" class="btn s-large newsecbtn">What we treat</a>
        </div>
    </section>
    <section id="steps" class="steps threeSteps">
        <div class="container">
            ...
            <ul class="steps-list">
                <li>
                    <img class="step-icon" src="http://localhost/medic/assets/images/icons/Private-GP-Near-Me-Icon.png" alt="Map with a location marker and the MedicSpot logo to illustrate the short distance to your nearest private GP">
                    <h3>Book Online</h3>
                    <p class="margintop">Book a convenient same day private GP appointment.</p>
                </li>
                <li>
                    <img class="step-icon" src="http://localhost/medic/assets/images/icons/Online-Doctor.png" alt="Illustration of an online doctor with a stethoscope draped over the doctor's shoulders"  >
                ...
                <li>
                    <img class="step-icon" src="http://localhost/medic/assets/images/icons/Prescription.png" alt=" Illustration of two antibiotics and your prescription" >
    ...
    <section id="video" class="dots-background with-media home_vedio homeGpSecTop">
        ...
        <div class="walkInbtn_div">
			<div class="mobileScreenshow">
        		<a href="http://localhost/medic/our-clinics" class="btn s-large newsecbtn">Walk in centre near me</a>
			</div>
        </div>
    </section>
	...
	<img src="http://localhost/medic/assets/images/logo/logo-st.png" title="Secure &amp; trusted" alt="Secure and trusted logo" >
	<img src="http://localhost/medic/assets/images/logo/logo-gmc.png" title="General Medical Council" alt="General Medical Council logo" >
	<img src="http://localhost/medic/assets/images/logo/logo-ico.png" title="Information Commissionerâ€™s Office" alt="ICO logo" >
	<img src="http://localhost/medic/assets/images/logo/logo-cqc.png" title="CareQuality Commission" alt="Care Quality Commission logo" >            </div>
        </div>
    </section>
    <section id="logos-media">
        <div class="container">
            ...
            <div class="logos-list">
                <img src="http://localhost/medic/assets/images/logo/logo-bbc.png" title="BBC" alt="BBC logo" >
                <img src="http://localhost/medic/assets/images/logo/logo-metro.png" title="Metro" alt="Metro logo" >
                <img src="http://localhost/medic/assets/images/logo/logo-pj.png" title="The Pharmaceutical Journal" tag="The Pharmaceutical Journal logo" >
                <img src="http://localhost/medic/assets/images/logo/logo-et.png" title="Evening Times" alt="Evening Times logo" >
                <img src="http://localhost/medic/assets/images/logo/logo-pulse.png" title="Pulse" alt="Pulse logo" >
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="testimonials-quotes testimonials-slicky" id="slickySlidertext">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://localhost/medic/assets/images/Jacqueline.png">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://localhost/medic/assets/images/kelly2.png">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://localhost/medic/assets/images/trevor2.png">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://localhost/medic/assets/images/michael2.png">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://localhost/medic/assets/images/nolan2.png">
    ...
    <section id="call-to-action" class="call-to-action">
        <div class="container">
            ...
            <a href="http://localhost/medic/our-clinics" class="btn s-large s-rounded s-inverted">Book now</a>
...
<script language="javascript">
    ...
    function booking_Map() {  
        ...
        markerIcon = new google.maps.MarkerImage(
            'http://localhost/medic/assets/images/map-marker.png',
            ...
            new google.maps.Size(32, 32)
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(16);
					booking_SelectEstablishment();
					getAppointmentTimes(16, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(17);
					booking_SelectEstablishment();
					getAppointmentTimes(17, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(18);
					booking_SelectEstablishment();
					getAppointmentTimes(18, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(21);
					booking_SelectEstablishment();
					getAppointmentTimes(21, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(22);
					booking_SelectEstablishment();
					getAppointmentTimes(22, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(23);
					booking_SelectEstablishment();
					getAppointmentTimes(23, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(24);
					booking_SelectEstablishment();
					getAppointmentTimes(24, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(25);
					booking_SelectEstablishment();
					getAppointmentTimes(25, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(26);
					booking_SelectEstablishment();
					getAppointmentTimes(26, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(28);
					booking_SelectEstablishment();
					getAppointmentTimes(28, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(29);
					booking_SelectEstablishment();
					getAppointmentTimes(29, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(30);
					booking_SelectEstablishment();
					getAppointmentTimes(30, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(31);
					booking_SelectEstablishment();
					getAppointmentTimes(31, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(32);
					booking_SelectEstablishment();
					getAppointmentTimes(32, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(33);
					booking_SelectEstablishment();
					getAppointmentTimes(33, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(34);
					booking_SelectEstablishment();
					getAppointmentTimes(34, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(35);
					booking_SelectEstablishment();
					getAppointmentTimes(35, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(36);
					booking_SelectEstablishment();
					getAppointmentTimes(36, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(37);
					booking_SelectEstablishment();
					getAppointmentTimes(37, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(38);
					booking_SelectEstablishment();
					getAppointmentTimes(38, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(39);
					booking_SelectEstablishment();
					getAppointmentTimes(39, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(40);
					booking_SelectEstablishment();
					getAppointmentTimes(40, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(41);
					booking_SelectEstablishment();
					getAppointmentTimes(41, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(42);
					booking_SelectEstablishment();
					getAppointmentTimes(42, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(43);
					booking_SelectEstablishment();
					getAppointmentTimes(43, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(44);
					booking_SelectEstablishment();
					getAppointmentTimes(44, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(45);
					booking_SelectEstablishment();
					getAppointmentTimes(45, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(46);
					booking_SelectEstablishment();
					getAppointmentTimes(46, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(47);
					booking_SelectEstablishment();
					getAppointmentTimes(47, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(48);
					booking_SelectEstablishment();
					getAppointmentTimes(48, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(49);
					booking_SelectEstablishment();
					getAppointmentTimes(49, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(50);
					booking_SelectEstablishment();
					getAppointmentTimes(50, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(51);
					booking_SelectEstablishment();
					getAppointmentTimes(51, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(52);
					booking_SelectEstablishment();
					getAppointmentTimes(52, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(53);
					booking_SelectEstablishment();
					getAppointmentTimes(53, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(54);
					booking_SelectEstablishment();
					getAppointmentTimes(54, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(55);
					booking_SelectEstablishment();
					getAppointmentTimes(55, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(56);
					booking_SelectEstablishment();
					getAppointmentTimes(56, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(57);
					booking_SelectEstablishment();
					getAppointmentTimes(57, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(58);
					booking_SelectEstablishment();
					getAppointmentTimes(58, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(59);
					booking_SelectEstablishment();
					getAppointmentTimes(59, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(61);
					booking_SelectEstablishment();
					getAppointmentTimes(61, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(62);
					booking_SelectEstablishment();
					getAppointmentTimes(62, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(63);
					booking_SelectEstablishment();
					getAppointmentTimes(63, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(65);
					booking_SelectEstablishment();
					getAppointmentTimes(65, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(66);
					booking_SelectEstablishment();
					getAppointmentTimes(66, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(67);
					booking_SelectEstablishment();
					getAppointmentTimes(67, '26-04-2018');	
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(68);
					booking_SelectEstablishment();
					getAppointmentTimes(68, '26-04-2018');	
		...
		<footer id="page-footer">
			<div class="container">
				<nav id="page-quick-access">
					<section>
						...
						<ul>
							<li><a href="http://localhost/medic/how-it-works">How it works</a></li>
							<li><a href="http://localhost/medic/what-we-treat">What we treat</a></li>
							<li><a href="http://localhost/medic/team">About us</a></li>
							<li><a href="http://localhost/medic/faq">FAQ</a></li>
							<li><a href="http://localhost/medic/contact">Contact Us</a></li>
						</ul>
					</section>
					<section>
						<h3>What we offer</h3>
						<ul>
							<li><a href="http://localhost/medic/our-clinics">Our clinics</a></li>
							<li><a href="http://localhost/medic/pricing">Pricing</a></li>
							<li><a href="http://localhost/medic/reviews">Reviews</a></li>
							<li><a href="http://localhost/medic/blog">Blog</a></li>
							<li><a href="http://localhost/medic/press">Press</a></li>
						</ul>
					</section>
					<section>
						<h3>Partners</h3>
						<ul>
							<li><a href="http://localhost/medic/pharmacies">For Pharmacy</a></li>
							<li><a href="http://localhost/medic/businesses">For Business</a></li>
							<li><a href="http://localhost/medic/for-doctors">For Doctors</a></li>
						</ul>
					</section>
				</nav>
			...
			<div id="page-legal">
				<div class="container">
					<a href="http://localhost/medic/terms" target="_blank">Terms & Conditions</a>
					<a href="http://localhost/medic/privacy" target="_blank">Privacy &amp; Cookies Policy</a>
					...
					<div id="mhra-fmd-placeholder" style="text-align: right;">
						<a href="https://medicine-seller-register.mhra.gov.uk/search-registry/649" target="_blank">
							<img src="http://localhost/medic/assets/images/mhra.png" style="width:90px;" alt="Verification icon" >
						</a>
					</div>
