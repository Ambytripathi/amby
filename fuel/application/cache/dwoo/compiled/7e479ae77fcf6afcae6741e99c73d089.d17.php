		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Glasgow_Clinic.JPG)" aria-label="MedicSpot Clinic Glasgow City Centre" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Glasgow_Clinic_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Glasgow City Centre" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Glasgow_Clinical_Station.JPG)" aria-label="MedicSpot Clinic Glasgow City Centre" ></div>
											</div>
