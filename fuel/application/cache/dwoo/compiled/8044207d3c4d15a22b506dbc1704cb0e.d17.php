...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Skip The Wait - Same Day Private GP Oxford Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="GP Oxford">
    <meta name="description" content="Same day private GP Oxford appointments for only £39. MedicSpot's GP Oxford Walk In Centre is conveniently located on Botley Road inside Woodlands Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.7524636';
globals.lng = '-1.2775974999999562';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Oxford</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A GP In Oxford						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Oxford</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Oxford Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>82 Botley Road, Oxford, OX2 0BU, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>01865 595 399</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-clock-o" title="Opening Times"></i>
						<span>
							<strong>Opening Times</strong><br>
							<table cellpadding="10" cellspacing="10"><tr><td>Monday:</td><td> 09:00 to 17:30 </td></tr><tr><td>Tuesday:</td><td> 09:00 to 17:30 </td></tr><tr><td>Wednesday:</td><td> 09:00 to 17:30 </td></tr><tr><td>Thursday:</td><td> 09:00 to 17:30 </td></tr><tr><td>Friday:</td><td> 09:00 to 17:30 </td></tr><tr><td>Saturday:</td><td> 09:00 to 13:00 </td></tr><tr><td>Sunday:</td><td> Closed</td></tr></table>						</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-envelope" title="Email Address"></i>
						<span>
							<a href="mailto:oxford@medicspot.co.uk">oxford@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day private GP Oxford appointments from Woodlands Pharmacy. You can easily see a GP from MedicSpot's GP Oxford Walk In Centre located on Botley Road close to the Oxford Railway Station. MedicSpot Clinic Oxford is an online private GP service where you can instantly speak to one of our expert NHS registered doctors Monday to Saturday. This service is ideal for those who find it difficult to get an NHS GP Oxford appointment. Skip the wait and book a private GP appointment at a time that suits you.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:01865 595 399" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Oxford_Clinic_.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Oxford_Clinic_Consulting_Room_.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Oxford_Clinic_Medical_Station_.jpg)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See An Oxford GP Today</h1>
            <p>Visit our Oxford walk in centre to see a private GP</p>
