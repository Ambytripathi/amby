...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Stockwell GP Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Stockwell GP">
    <meta name="description" content="Same day Stockwell GP appointments for only £39. MedicSpot's Doctors Surgery Stockwell is conveniently located on Clapham Road inside Harfleur Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.471922';
globals.lng = '-0.122539';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Stockwell</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A Stockwell GP						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Stockwell</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Stockwell Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>219-221 Clapham Rd, Stockwell, London SW9 9BE, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3682</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:stockwell@medicspot.co.uk">stockwell@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>"Skip the wait and book a Stockwell GP appointment at a time that suits you. You can easily see a doctor from MedicSpot's GP Stockwell Station Walk In Centre using Northern or Victoria lines from Stockwell Underground Station (1-minute walk). MedicSpot's Doctors Surgery Stockwell is less 0.1 miles away for patients looking for a Stockwell GP on Binfield Road or a Stockwell GP on South Lambeth Road. MedicSpot Clinic Stockwell GP opening times are 9am-6pm Monday-Friday and 9am-5pm on Saturday. Select a time, book online, and see a private GP instantly."</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3682" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Stockwell_GP_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Stockwell_GP_Clinic_Consulting_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Stockwell_GP_Clinic_Medical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Stockwell GP Today</h1>
            <p>Visit our Stockwell walk in centre to see a private GP</p>
