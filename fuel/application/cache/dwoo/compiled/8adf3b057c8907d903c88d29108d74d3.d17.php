...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Skip The Wait - Same Day Private GP Islington Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="GP Islington">
    <meta name="description" content="Same day private GP Islington appointments for only £39. MedicSpot's Islington Medical Centre London is conveniently located on Upper Street inside Rose Chemist. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.545105';
globals.lng = '-0.103492';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Islington</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A GP In Islington						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Islington</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Islington Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>243 Upper Street, Islington, London N1 1RU, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3937 9886</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:islington@medicspot.co.uk">islington@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Skip the wait and book a private GP Islington appointment at a time that suits you. You can easily see a private GP from MedicSpot's Islington Medical Centre London using the Victoria line, Great Northern, or Overground services from Highbury & Islington Station (2-minute walk). Our out of hours GP Islington Clinic is open 9am-6pm Monday-Friday and 9am-5pm on Saturday. You no longer have to wait weeks for an appointment with your regular NHS GP in Islington - simply select a convenient time and book online for a private GP Islington appointment.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3937 9886" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Islington_GP_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Islington_GP_Clinic_Consulting_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Islington_GP_Clinic_Medical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See An Islington GP Today</h1>
            <p>Visit our Islington walk in centre to see a private GP</p>
