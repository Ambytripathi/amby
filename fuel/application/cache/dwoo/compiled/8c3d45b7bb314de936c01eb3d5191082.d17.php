...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Same Day Doctor Near Me - Press    </title>
    	
	
	<meta name="title" content="Press Meta Title">
    <meta name="keywords" content="">
    <meta name="description" content="Press Find a nearby walk in GP service and get seen by a fully qualified doctor today. Learn more.">
	...
	<section id="blog-article-list">
		<div class="container">
				<div class="article-list">
										<a href="https://www.medicspot.co.uk/press/fitzwilliam-virtual-gp-practice">
						<article class="blog-item">
							<div class="blog-item-thumbnail" style="background-image: url(https://www.medicspot.co.uk/assets/images/Pharmacy_Magazine_1.png);background-size:cover;"></div>
							<div class="blog-item-content">
								<h3>A Virtual GP Surgery Within a Pharmacy</h3>
								<h4><strong>Dr Zubair Ahmed</strong></h4>
								<h4 style="margin-top: 10px"><strong>
									12/01/2018									</strong></h4>
								
								<p>
									Find out why and how Fitzwilliam Pharmacy in Cambridge opened up a virtual GP surgery with MedicSpot.								</p>
							</div>
						</article>
					</a>
										<a href="https://www.medicspot.co.uk/press/pharmacy-to-roll-out-virtual-gp-surgery-service-after-successful-pilot">
						<article class="blog-item">
							<div class="blog-item-thumbnail" style="background-image: url(https://www.medicspot.co.uk/assets/images/pharmaceutical_journal_logo.png);background-size:cover;"></div>
							<div class="blog-item-content">
								<h3>Pharmacy to roll out virtual GP surgery service after successful pilot</h3>
								<h4><strong></strong></h4>
								<h4 style="margin-top: 10px"><strong>
									11/02/2018									</strong></h4>
								
								<p>
									Read about Fitzwilliam Pharmacy, one of the oldest pharmacies in the UK, and their decision to innovate and increase their service offering by working with MedicSpot to open up a virtual GP surgery.								</p>
							</div>
						</article>
					</a>
									</div>
