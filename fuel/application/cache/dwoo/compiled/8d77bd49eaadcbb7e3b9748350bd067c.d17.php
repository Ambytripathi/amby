...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day St Johns Wood GP Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="St Johns Wood GP">
    <meta name="description" content="Same day St Johns Wood GP appointments for only £39. MedicSpot's St Johns Wood GP Walk In Clinic is conveniently located on St John's Wood High Street inside Courtenay Chemist. Skip the wait, select a time, and book a private GP appointment.">
...
globals = { };
globals.lat = '51.5322723';
globals.lng = '-0.1694315';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic St Johns Wood</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A St Johns Wood GP						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic St Johns Wood</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our St Johns Wood Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>3 St John's Wood High St, London NW8 7NG, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3326 5239</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:stjohnswood@medicspot.co.uk">stjohnswood@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day St Johns Wood GP appointments from Courtenay Chemist. You can easily see a St Johns Wood GP from our MedicSpot Clinic St Johns Wood using the Jubilee line from St John's Wood Underground Station (6-minute walk). If you're looking for a St Johns Wood GP Wellington Road, our clinic is only 0.3 miles away. You no longer have to wait weeks for an appointment with your regular NHS GP. Any prescribed medication can be collected instantly on your way out. Select a time, book online, and see a private doctor instantly.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3326 5239" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/St_Johns_Wood_GP_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/St_Johns_Wood_GP_Clinic_Consulting_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/St_Johns_Wood_GP_Clinic_Medical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A St Johns Wood GP Today</h1>
            <p>Visit our St Johns Wood walk in centre to see a private GP</p>
