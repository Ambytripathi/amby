...
<head>
    ...
    <link rel="stylesheet" href="http://fixwebsupport.com/ambi/assets/css/site.normalize.css">
    <link rel="stylesheet" href="http://fixwebsupport.com/ambi/assets/css/custom.css">
    <link rel="stylesheet" href="http://fixwebsupport.com/ambi/assets/css/site.booking.css">
    ...
    <link rel="stylesheet" href="http://fixwebsupport.com/ambi/assets/css/slick.css"/>
    ...
    <script src="http://fixwebsupport.com/ambi/assets/js/site.main.js" defer></script>
    <script src="http://fixwebsupport.com/ambi/assets/js/moment-with-locales.js"></script>
...
<header id="page-header">
    <div class="container">
        <div class="page-header-wrapper">
            <a href="http://fixwebsupport.com/ambi/" class="page-logo" title="Medicspot" style="background: url('http://fixwebsupport.com/ambi/assets/images/logo-ms.png');    background-size: 15.2rem 4.8rem;">Medicspot</a>
            <nav class="nav-main">
                ...
                <a href="http://fixwebsupport.com/ambi/pricing" >Pricing</a>
                <a href="http://fixwebsupport.com/ambi/how-it-works" >How it works</a>
                <a href="http://fixwebsupport.com/ambi/our-clinics"  class="btn bokNowbtn">Book Now</a>
...
<div id="NEEDHELP_MODEL" class="modal">
  <div class="modal-content">
    ...
    <div class="block one">
        <img src="http://fixwebsupport.com/ambi/assets/images/client_msg.png" alt="Chat with MedicSpot icon" />
        <a href="javascript:void(0);" onclick="openChat();return false;" class="btn chatteam" id="chatteam">Chat With Our Team</a>
    </div>
    <div class="block two">
        <img src="http://fixwebsupport.com/ambi/assets/images/client_email.png" alt="Call MedicSpot icon" />
        <a href="mailto:info@medicspot.co.uk" class="btn">info@medicspot.co.uk</a>
    </div>
    <div class="block three">
        <img src="http://fixwebsupport.com/ambi/assets/images/client_call.png" alt="Call MedicSpot icon" />
...
<link rel="stylesheet" href="http://fixwebsupport.com/ambi/assets/css/ladda-themeless.min.css">
<script src="http://fixwebsupport.com/ambi/assets/js/spin.min.js"></script>
<script src="http://fixwebsupport.com/ambi/assets/js/ladda.min.js"></script>
...
<div id="booking-panel">
	...
	<div class="booking-panel-table">
		...
		<div class="booking-panel-day-selector-wrapper">
			...
			<img style="display: none;height: 200px; position: absolute; left: 135px; margin-top: 89px;" id="booking-loader" src="http://fixwebsupport.com/ambi/assets/img/loading.gif" alt="Circular loading gif" >		
	...
	<div class="booking-form" style="display:none;">
		<div class="frame-content " style="max-height: 308px;margin-bottom: 5px;">
			<img style="display: none;" id="confirm-loader" src="http://fixwebsupport.com/ambi/assets/img/loading.gif" alt="Circular loading gif" >
				<div class="row">
                            ...
                            <div class="form-group form-padding" style="text-align: left;">
                            	...
                            	<tr>
                            		...
                            		<td>
                            			<label class="control-label">I accept the <a href="http://fixwebsupport.com/ambi/terms">Terms and Conditions</a> (no under 5's)</label>
                            		</td>
                            	</tr>
                            	</table>
                            </div>
...
$( document ).ready(function() { 
	...
	$('body').on('keyup', '#postcode_search', function(){ 	
		if($('#postcode_search').val().length>=2){ 			
			$.ajax({ 
				type: "POST",
				url: 'http://fixwebsupport.com/ambi/Clinic_search/postcode_search',
	...
	$('#confirm').on('click', function(){ 	
		...
		if(clinic_id < 1){ 
			...
			$.ajax({ 
				type: "POST",
				url: 'http://fixwebsupport.com/ambi/index.php/appointments/ajax_register_appointment',
				data: { 
				...
				{ 	
					...
					if(data.status==0){ 
						...
						window.location.href="http://fixwebsupport.com/ambi/booking_confirm";
					}
				}
			});
		}
	...
	$('.booking-input input').click(function () { 
		...
		$.ajax({ 
			type: "POST",
			url: 'http://fixwebsupport.com/ambi/Clinic_search/search',
	...
	$('body').on('click', '.suggestion', function(){ 
		...
		navigator.geolocation.getCurrentPosition(function(position) { 
			...
			var destLon = globals.lng;
		 	var image = 'http://fixwebsupport.com/ambi/assets/images/clinic.png';
			...
			var image_start = 'http://fixwebsupport.com/ambi/assets/images/clinic_start.png';
			var marker = new google.maps.Marker({ 				
...
function loadClinicData(clinic_id, distance){ 
	...
	$.ajax({ 
			type: "POST",
			url: 'http://fixwebsupport.com/ambi/Clinic_search/clinic_data',
			...
			var marker = new google.maps.Marker({ 				
				...
				if(data.url!=''){ 
					...
					jQuery('#www_span').html('<a href="http://fixwebsupport.com/ambi/clinics/'+url+'/">More Details</a>');
				}else{ 
					jQuery('#www_span').html('<a href="http://fixwebsupport.com/ambi/establishment/'+data.clinic_id+'">More Details</a>');	
				}
				

				if(data.image1!=''){ 
					jQuery('.photo1').attr('style',"background-image:url(http://fixwebsupport.com/ambi/assets/images/"+data.image1+");");
				}
				if(data.image2!=''){ 
					jQuery('.photo2').attr('style',"background-image:url(http://fixwebsupport.com/ambi/assets/images/"+data.image2+");");
				}
				if(data.image3!=''){ 
					jQuery('.photo3').attr('style',"background-image:url(http://fixwebsupport.com/ambi/assets/images/"+data.image3+");");
				}
			}
	});
}
...
function getAppointmentTimes(clinic_id, date){ 
	...
	$.ajax({ 
			type: "POST",
			url: 'http://fixwebsupport.com/ambi/index.php/appointments/ajax_get_available_hours',
...
$( document ).ready(function(){ 
    ...
    <section id="steps" class="steps howWeHelpYou">
        <div class="container">
            ...
            <p class="help_description">MedicSpot makes it simple and easy to get the care you need – no matter where you are or when you need it. We answer your search for “private GP london” or “private GP near me” with 50+ pharmacy <a href="http://fixwebsupport.com/ambi/our-clinics">walk in centres.</a> Our nationwide coverage gives you convenient access to private GPs so you never have to wait for healthcare again.</p>
            <ul class="steps-list">
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/assets/images/icons/clock.png" alt="White clock icon on MedicSpot purple background">
                ...
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/assets/images/icons/stethoscope.png" alt="White stethoscope icon on MedicSpot purple background" >
                ...
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/assets/images/icons/documentapprove.png" alt="White clipboard icon with check mark on MedicSpot purple background" >
            ...
            <a href="http://fixwebsupport.com/ambi/what-we-treat" class="btn s-large newsecbtn">What we treat</a>
        </div>
    </section>
    <section id="steps" class="steps threeSteps">
        <div class="container">
            ...
            <ul class="steps-list">
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/assets/images/icons/Private-GP-Near-Me-Icon.png" alt="Map with a location marker and the MedicSpot logo to illustrate the short distance to your nearest private GP">
                    <h3>Book Online</h3>
                    <p class="margintop">Book a convenient same day private GP appointment.</p>
                </li>
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/assets/images/icons/Online-Doctor.png" alt="Illustration of an online doctor with a stethoscope draped over the doctor's shoulders"  >
                ...
                <li>
                    <img class="step-icon" src="http://fixwebsupport.com/ambi/assets/images/icons/Prescription.png" alt=" Illustration of two antibiotics and your prescription" >
    ...
    <section id="video" class="dots-background with-media home_vedio homeGpSecTop">
        ...
        <div class="walkInbtn_div">
			<div class="mobileScreenshow">
        		<a href="http://fixwebsupport.com/ambi/our-clinics" class="btn s-large newsecbtn">Walk in centre near me</a>
			</div>
        </div>
    </section>
	...
	<img src="http://fixwebsupport.com/ambi/assets/images/logo/logo-st.png" title="Secure &amp; trusted" alt="Secure and trusted logo" >
	<img src="http://fixwebsupport.com/ambi/assets/images/logo/logo-gmc.png" title="General Medical Council" alt="General Medical Council logo" >
	<img src="http://fixwebsupport.com/ambi/assets/images/logo/logo-ico.png" title="Information Commissionerâ€™s Office" alt="ICO logo" >
	<img src="http://fixwebsupport.com/ambi/assets/images/logo/logo-cqc.png" title="CareQuality Commission" alt="Care Quality Commission logo" >            </div>
        </div>
    </section>
    <section id="logos-media">
        <div class="container">
            ...
            <div class="logos-list">
                <img src="http://fixwebsupport.com/ambi/assets/images/logo/logo-bbc.png" title="BBC" alt="BBC logo" >
                <img src="http://fixwebsupport.com/ambi/assets/images/logo/logo-metro.png" title="Metro" alt="Metro logo" >
                <img src="http://fixwebsupport.com/ambi/assets/images/logo/logo-pj.png" title="The Pharmaceutical Journal" tag="The Pharmaceutical Journal logo" >
                <img src="http://fixwebsupport.com/ambi/assets/images/logo/logo-et.png" title="Evening Times" alt="Evening Times logo" >
                <img src="http://fixwebsupport.com/ambi/assets/images/logo/logo-pulse.png" title="Pulse" alt="Pulse logo" >
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="testimonials-quotes testimonials-slicky" id="slickySlidertext">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://fixwebsupport.com/ambi/assets/images/Jacqueline.png">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://fixwebsupport.com/ambi/assets/images/kelly2.png">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://fixwebsupport.com/ambi/assets/images/trevor2.png">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://fixwebsupport.com/ambi/assets/images/michael2.png">
                        ...
                        <blockquote>
                            ...
                            <footer>
                                <img class="testimony-avatar" src="http://fixwebsupport.com/ambi/assets/images/nolan2.png">
    ...
    <section id="call-to-action" class="call-to-action">
        <div class="container">
            ...
            <a href="http://fixwebsupport.com/ambi/our-clinics" class="btn s-large s-rounded s-inverted">Book now</a>
...
<script language="javascript">
    ...
    function booking_Map() {  
        ...
        markerIcon = new google.maps.MarkerImage(
            'http://fixwebsupport.com/ambi/assets/images/map-marker.png',
		...
		<footer id="page-footer">
			<div class="container">
				<nav id="page-quick-access">
					<section>
						...
						<ul>
							<li><a href="http://fixwebsupport.com/ambi/how-it-works">How it works</a></li>
							<li><a href="http://fixwebsupport.com/ambi/what-we-treat">What we treat</a></li>
							<li><a href="http://fixwebsupport.com/ambi/team">About us</a></li>
							<li><a href="http://fixwebsupport.com/ambi/faq">FAQ</a></li>
							<li><a href="http://fixwebsupport.com/ambi/contact">Contact Us</a></li>
						</ul>
					</section>
					<section>
						<h3>What we offer</h3>
						<ul>
							<li><a href="http://fixwebsupport.com/ambi/our-clinics">Our clinics</a></li>
							<li><a href="http://fixwebsupport.com/ambi/pricing">Pricing</a></li>
							<li><a href="http://fixwebsupport.com/ambi/reviews">Reviews</a></li>
							<li><a href="http://fixwebsupport.com/ambi/blog">Blog</a></li>
							<li><a href="http://fixwebsupport.com/ambi/press">Press</a></li>
						</ul>
					</section>
					<section>
						<h3>Partners</h3>
						<ul>
							<li><a href="http://fixwebsupport.com/ambi/pharmacies">For Pharmacy</a></li>
							<li><a href="http://fixwebsupport.com/ambi/businesses">For Business</a></li>
							<li><a href="http://fixwebsupport.com/ambi/for-doctors">For Doctors</a></li>
						</ul>
					</section>
				</nav>
			...
			<div id="page-legal">
				<div class="container">
					<a href="http://fixwebsupport.com/ambi/terms" target="_blank">Terms & Conditions</a>
					<a href="http://fixwebsupport.com/ambi/privacy" target="_blank">Privacy &amp; Cookies Policy</a>
					...
					<div id="mhra-fmd-placeholder" style="text-align: right;">
						<a href="https://medicine-seller-register.mhra.gov.uk/search-registry/649" target="_blank">
							<img src="http://fixwebsupport.com/ambi/assets/images/mhra.png" style="width:90px;" alt="Verification icon" >
						</a>
					</div>
