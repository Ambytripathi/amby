...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Abbey Road GP Appointments    </title>
    	
	
	<meta name="title" content="Book Same Day Abbey Road GP Appointment">
    <meta name="keywords" content="Abbey Road GP">
    <meta name="description" content="Same day Abbey Road doctors appointments for only  £. MedicSpot's Abbey Road Doctors Walk In Centre is conveniently located on Abbey Road inside Hodgetts Chemist. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.537667';
globals.lng = '-0.184479';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Abbey Road</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See An Abbey Road GP						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Abbey Road</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Abbey Road Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>79 Abbey Road, London NW8 0AE, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3958 0449</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:abbeyroad@medicspot.co.uk">abbeyroad@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day Abbey Road GP appointments from Hodgetts Chemist. You can easily see an Abbey Road GP from our MedicSpot Abbey Road Doctors Clinic using the Jubilee line from St. John's Wood Underground Station (12-minute walk), the Bakerloo line from Kilburn Park Underground Station (12-minute walk), or Overground services from Kilburn High Road (10-minute walk) or South Hampstead (8-minute walk). You no longer have to wait weeks for an appointment with your regular NHS GP. Select a time with an Abbey Road GP, book online, and see a private doctor instantly.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3958 0449" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Abbey_Road_GP_Hodgetts_Chemist.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Abbey_Road_GP_Consulting_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clinical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See An Abbey Road GP Today</h1>
            <p>Visit our Abbey Road walk in centre to see a private GP</p>
