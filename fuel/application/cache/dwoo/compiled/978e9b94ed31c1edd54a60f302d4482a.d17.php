...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Walk In Centre South Kensington - Same Day Private GPs    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Walk In Centre South Kensington">
    <meta name="description" content="Same day private GP appointments from MedicSpot's Walk In Centre South Kensington. Our Walk In Centre opening times are 9am-6pm Monday-Saturday. Skip the wait and book a private GP appointment for only £39 at a time that suits you.">
...
<header id="page-header">
	...
	<header id="page-header-two" style='display:block'>
        <div class="container">
            <div class="page-header-wrapper">
                <ul>
...
globals = { };
globals.lat = '51.4941275';
globals.lng = '-0.1740792';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic South Kensington Station</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To Visit Our Walk In Centre South Kensington						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic South Kensington Station</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our South Kensington Clinic</h3>
	...
	$('body').on('click', '.suggestion', function(){ 
		...
		navigator.geolocation.getCurrentPosition(function(position) { 
			...
			var destLon = globals.lng;
		 	var image = 'https://www.medicspot.co.uk/assets/images/map-marker.png';
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>6 S Kensington Station Arcade, Kensington, London SW7 2NA, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3663</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-clock-o" title="Opening Times"></i>
						<span>
							<strong>Opening Times</strong><br>
							<table cellpadding="10" cellspacing="10"><tr><td>Monday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Tuesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Wednesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Thursday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Friday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Saturday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Sunday:</td><td> Closed</td></tr></table>						</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-envelope" title="Email Address"></i>
						<span>
							<a href="mailto:southkensingtonstation@medicspot.co.uk">southkensingtonstation@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day private GP appointments from MedicSpot Clinic South Kensington Station. Our Walk In Centre South Kensington is conveniently located inside South Kensington Underground Station at Stickland Pharmacy and can be accessed using Circle, District, or Piccadilly lines. MedicSpot's Walk In Centre South Kensington is the nearest walk in centre for commuters using South Kensington Underground Station. Our Walk In Centre opening times are 9am-6pm Monday-Saturday. Select a convenient time, book online, and visit our Walk In Centre South Kensington.</p>
					<div class="innRightEstCntct">
						<a href="javascript:void(0);" onclick="openChat();return false;" class="btn chatteam" id="chatteam">Chat <img src="https://www.medicspot.co.uk/assets/images/icons/icon-7.png" alt="" ></a>
						<a href="callto:020 3946 3663" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_South_Kensington.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_South_Kensington_Inside.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_South_Kensington_Medical_Station.JPG)"></div>
											</div>
	...
	<section id="can-treat" class="treat-section newTreatSec">
		<div class="container">
			...
			<ul class="treat-list">
								<li>
					<h3>Aches & Pains</h3>
					<p>Arthritis, Back Pain, Muscle Sprains etc&hellip;</p>
				</li>
								<li>
					<h3>Allergies</h3>
					<p>Hayfever, House Dust Allergy, Itchy Eyes etc&hellip;</p>
				</li>
								<li>
					<h3>Chest Infections & Coughs</h3>
					<p>Asthma, Pneumonia, Reflux etc&hellip;</p>
				</li>
								<li>
					<h3>Colds & Flu</h3>
					<p>Influenza, Fever etc&hellip;</p>
				</li>
								<li>
					<h3>Ear, Nose & Throat</h3>
					<p>Sore Throat, Ear Problems, Sinusitis etc&hellip;</p>
				</li>
								<li>
					<h3>Eye Problems</h3>
					<p>Conjunctivitis, Red Eye, Stye, Blepharitis etc&hellip;</p>
				</li>
								<li>
					<h3>Headaches</h3>
					<p>Tension Headache, Migraine etc&hellip;</p>
				</li>
								<li>
					<h3>Men's Sexual Health</h3>
					<p>Erectile Dysfunction, Premature Ejaculation etc&hellip;</p>
				</li>
								<li>
					<h3>Mental Health Issues</h3>
					<p>Depression, Stress, Anxiety etc&hellip;</p>
				</li>
								<li>
					<h3>Skin Problems & Rash</h3>
					<p>Acne, Eczema, Fungal infection, Hairloss etc&hellip;</p>
				</li>
								<li>
					<h3>Urine Infections</h3>
					<p>Urine Infections, Cystitis, Incontinence etc&hellip;</p>
				</li>
								<li>
					<h3>Women's Sexual Health</h3>
					<p>(Emergency) Contraception, Heavy Periods etc&hellip;</p>
				</li>
								<li>
					<h3>Feet & Nail</h3>
					<p>Nail Infections, Athlete&rsquo;s Foot etc&hellip;</p>
				</li>
								<li>
					<h3>General Wellbeing</h3>
					<p>Weight Loss, Smoking Cessation etc&hellip;</p>
				</li>
								<li>
					<h3>Travel Medicine</h3>
					<p>Travel Advice, Travel Anxiety, Period Delay etc&hellip;</p>
				</li>
							</ul>
		</div>
	</section>
	...
	<section id="we-can-also">
		<div class="container">
			<div class="we-can-also">
				<img src="https://www.medicspot.co.uk/assets/images/icons/i-prescription.png">
...
<page id="how-it-works">
		...
		<div class="container">
			...
			<div class="clinical-station-diagram">
				<ul class="diagram-list">
					<li class="minHe">
						<div class="icon" style="background-image: url(https://www.medicspot.co.uk/assets/images/icons/icon-1.png)"></div>
						<div class="content">
					...
					<li class="minHe">
						<div class="icon" style="background-image: url(https://www.medicspot.co.uk/assets/images/icons/icon-2.png)"></div>
						<div class="content">
					...
					<li class="minHe">
						<div class="icon" style="background-image: url(https://www.medicspot.co.uk/assets/images/icons/icon-3.png)"></div>
						<div class="content">
				...
				<div class="diagram-image-wrapper">
					<img src="https://www.medicspot.co.uk/assets/images/how-it-works/Private-GP-Consultation.jpg">
				</div>

				<ul class="diagram-list">
					<li>
						<div class="icon" style="background-image: url(https://www.medicspot.co.uk/assets/images/icons/icon-4.png)"></div>
						<div class="content">
					...
					<li>
						<div class="icon" style="background-image: url(https://www.medicspot.co.uk/assets/images/icons/icon-5.png)"></div>
						<div class="content">
					...
					<li>
						<div class="icon" style="background-image: url(https://www.medicspot.co.uk/assets/images/icons/icon-6.png)"></div>
						<div class="content">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A South Kensington GP Today</h1>
            <p>Visit our South Kensington walk in centre to see a private GP</p>
	...
	function booking_Map() { 		
		...
		// Add Markers.
				...
				marker.addListener('click', function() { 
					...
					loadClinicData(27);
					booking_SelectEstablishment();
					getAppointmentTimes(27, '21-04-2018');			 	
			...
			var destLat = parseFloat(51.9952375);
			var destLon = parseFloat(-0.7278389);
