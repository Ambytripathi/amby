...
<head>
    ...
    <title>
        A Virtual GP Surgery Within a Pharmacy    </title>
    	
	
	<meta name="title" content="Press Meta Title">
    <meta name="keywords" content="First Press Release Meta Keywords">
    <meta name="description" content="First Press Release Meta Description">
		...
		<section id="blog-index-header" class="text-section">
			<div class="container">
				<div class="section-header">
					<h1><!--__FUEL_MARKER__0-->A Virtual GP Surgery Within a Pharmacy</h1>
			...
			<div class="container">
				<div class="article">
					<p class="introduction">
						Find out why and how Fitzwilliam Pharmacy in Cambridge opened up a virtual GP surgery with MedicSpot.						
						<p>Naveed Razzaque, operations manager at Fitzwilliam Pharmacy in Cambridge, speaks to Pharmacy Magazine on why his pharmacy wanted to work with MedicSpot to deliver a new service to its local community.<br />
<br><br />
<br><br />
<a href="http://www.pharmacymagazine.co.uk/a-virtual-gp-surgery-within-a-pharmacy" target="_blank">Click Here To Find Out More</a><br />
<br></p> 					</p>
				</div>
