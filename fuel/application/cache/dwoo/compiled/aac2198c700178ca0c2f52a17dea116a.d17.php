		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Chelsea_Clinic.jpg)" aria-label="MedicSpot Clinic Chelsea" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Chelsea_Clinic_Consulting_Room.jpg)" aria-label="MedicSpot Clinic Chelsea" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Chelsea_Clinic_Medical_Station.jpg)" aria-label="MedicSpot Clinic Chelsea" ></div>
											</div>
