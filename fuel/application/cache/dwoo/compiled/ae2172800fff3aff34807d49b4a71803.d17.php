		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Bletchley_Doctors_Clinic.jpg)" aria-label="MedicSpot Clinic Bletchley" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Bletchley_Doctors_Consultation_Room.jpg)" aria-label="MedicSpot Clinic Bletchley" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Bletchley_Doctors_Clinical_Station.jpg)" aria-label="MedicSpot Clinic Bletchley" ></div>
											</div>
