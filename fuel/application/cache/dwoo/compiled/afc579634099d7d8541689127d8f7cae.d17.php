    ...
    <section class="logoHome" id="logos-qa" style="background-color:#F4F6F7">
        <div class="container">
            ...
            <div class="logos-list" style="border:2px solid #6D56EE;border-radius:10px">
                <img src="http://fixwebsupport.com/ambi/medicspot/assets/images/logo/logo-cqc.png" style="color:#6D56EE;">MedicSpot is regulated by the Care Quality Commision<br>and is one of only afew digital healthcare providers to have<br>received top marks for clinical safety
