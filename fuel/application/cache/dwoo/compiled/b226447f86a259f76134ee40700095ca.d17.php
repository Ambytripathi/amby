...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Booking Confirmation    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Booking, Confirmation">
...
</div><page id="how-it-works">
	<section id="contact-info" class="dots-background text-section">
		<div class="container">
			<div class="section-header" style="padding: 4rem 0 0rem;">
				<h1>Booking Confirmation</h1>
				<p class="subtitle"><!--__FUEL_MARKER__1--></p>
			</div>
			<div class="content">
				<p style="">
					<br>Your pre-booking code:<br><span style="text-align:center;font-size:33px;font-weight:bold;"><b>TYHG78</b></span><br><br>Please keep a note of your pre-booking  code as there may be a delay without it<br><br>Please arrive 10 mins before your appointment time and show this code to a member of the pharmacy staff to avoid a delay in seeing the doctor<br><br>You will be connected to one of our online doctors instantly to get the help you need through our Medicspot Clinical Station<br><br>                
                ...
                <p class="confirm_msg_p">
                    <span style="text-align:center;color: #000;font-weight:bold;"><b>Appointment Details:</b></span>
                        <br>
                        Gemma Hall<br>
                    Appointment 21/04/2018, 14:00 at 
                       
                    MedicSpot Clinic Leeds Roundhay
                        <br>
                        <br>
                    <span style="color: #ff585b;">Khan Pharmacy Leeds</span>
                        <br>
                    168 Roundhay Road, Leeds LS8 5PL, United Kingdom
                        <br>
                        <br>
                    Amount Billed: &pound;39.00<span style="color:#000;"></span>
                </p>	
				</p>
			</div>
		</div>
