...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Grosvenor Doctors Service    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Grosvenor Doctors">
    <meta name="description" content="Same day Grosvenor doctors appointment for only £39. MedicSpot's Grosvenor Doctors Walk In Centre is conveniently located on South Audley Street inside Audley Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.5097839';
globals.lng = '-0.1516887';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Grosvenor Square</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See Our Grosvenor Doctors						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Grosvenor Square</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Grosvenor Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>36 S Audley St, Mayfair, London W1K 2PL, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3909</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-clock-o" title="Opening Times"></i>
						<span>
							<strong>Opening Times</strong><br>
							<table cellpadding="10" cellspacing="10"><tr><td>Monday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Tuesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Wednesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Thursday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Friday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Saturday:</td><td> 09:30 to 18:00 </td></tr><tr><td>Sunday:</td><td> Closed</td></tr></table>						</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-envelope" title="Email Address"></i>
						<span>
							<a href="mailto:grosvenorsquare@medicspot.co.uk">grosvenorsquare@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day Grosvenor doctors appointment from Audley Pharmacy. You can easily see a private GP from MedicSpot's Grosvenor Doctors Clinic using Central or Jubilee lines from Bond Street Underground Station (9-minute walk). MedicSpot Clinic Grosvenor Square is an online private GP service where you can instantly speak to one of our expert NHS registered doctors Monday to Saturday. Seeing MedicSpot Grosvenor doctors would be a convenient alternative to your regular NHS GP if you're living, working, or visiting in the area.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3909" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Grosvenor_Square_Doctors_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Grosvenor_Square_Doctors_Clinic_Inside.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Grosvenor_Square_Doctors_Clinic_Consulting_Room.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Grosvenor GP Today</h1>
            <p>Visit our Grosvenor walk in centre to see a private GP</p>
