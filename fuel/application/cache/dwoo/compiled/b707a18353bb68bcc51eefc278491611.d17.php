...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Private Pimlico GP Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Pimlico GP">
    <meta name="description" content="Same day Pimlico GP appointments for only £39. MedicSpot's Walk In Clinic Pimlico is conveniently located on Warwick Way inside Warwick Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.491989';
globals.lng = '-0.140335';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Pimlico</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A Pimlico GP						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Pimlico</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Pimlico Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>34-36 Warwick Way, Pimlico, London SW1V 1RY, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3690</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:pimlico@medicspot.co.uk">pimlico@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Skip the wait and book a Pimlico GP appointment at a time that suits you. You can easily see a Pimlico GP from MedicSpot's Walk In Clinic Pimlico using Circle, District, or Victoria lines from Victoria Underground Station (5-minute walk). MedicSpot Clinic Pimlico is less than 0.4 miles away from Westminster Cathedral, making it ideal for tourists who are unable to register with a Pimlico GP NHS Surgery. If you are living, working, or visiting the area, simply select a time and book online to see a Pimlico GP instantly.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3690" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Pimlico_GP_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Pimlico_GP_Clinic_Consulting_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Pimlico_GP_Clinic_Medical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Pimlico GP Today</h1>
            <p>Visit our Pimlico walk in centre to see a private GP</p>
