...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Blog Article    </title>
    	
	
	<meta name="title" content="Meta title Navigating Through Sick Notes">
    <meta name="keywords" content="What is a sick note? How long do I need to be ill before I get one? This and many more questions answered here.">
    <meta name="description" content="Meta Keywods Navigating Through Sick Notes">
		...
		<section id="blog-index-header" class="text-section">
			<div class="container">
				<div class="section-header">
					<h1><!--__FUEL_MARKER__1-->Navigating Through Sick Notes</h1>
