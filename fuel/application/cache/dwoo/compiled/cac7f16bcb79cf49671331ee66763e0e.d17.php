...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Walk In Centre Luton - Same Day Private GP Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Walk In Centre Luton">
    <meta name="description" content="Same day private GP appointments from MedicSpot's Walk In Centre Luton. Our Walk In Centre Luton opening times are 9am-6pm Monday-Sunday. Skip the wait and book a private GP appointment for only £39 at a time that suits you.">
...
globals = { };
globals.lat = '51.892541';
globals.lng = '-0.430155';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Luton Biscot</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To Visit Our Walk In Centre Luton						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Luton Biscot</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Luton Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>157a Biscot Rd, Luton LU3 1AW, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>01582 320675</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:biscot@medicspot.co.uk">biscot@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day private GP appointments from MedicSpot Clinic Luton Biscot. Our Walk In Centre Luton is conveniently located on Biscot Road inside Biscot Pharmacy. MedicSpot's Urgent GP Clinic Luton is less than a 20-minute drive for patients looking for a walk in centre in Dunstable, making it ideal for commuters and residents who are unable to wait hours at their local NHS walk in centre. Our Walk In Centre Luton opening times are 9am-6pm Monday-Sunday. Book online to see a Luton GP instantly or contact our Walk In Centre Luton phone number for any specific booking queries - 01582 320675.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:01582 320675" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Walk_In_Centre_Luton.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Luton_Consulting_Room.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Luton_Clinical_Station.jpg)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Luton GP Today</h1>
            <p>Visit our Luton walk in centre to see a private GP</p>
