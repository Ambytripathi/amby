...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Woolwich GP Appointments    </title>
    	
	
	<meta name="title" content="MedicSpot Clinic Woolwich">
    <meta name="keywords" content="Woolwich GP">
    <meta name="description" content="Same day Woolwich GP appointments for only £39. MedicSpot's Walk In Clinic Woolwich is conveniently located on Woolwich New Road inside Woolwich Late Night Pharmacy. Skip the wait and book a private GP appointment at a time that suits you.">
...
globals = { };
globals.lat = '51.4906826';
globals.lng = '0.0696306';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Woolwich</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A Woolwich GP						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Woolwich</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Woolwich Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>10 Woolwich New Rd, Woolwich, London SE18 6EX, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3999</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:woolwich@medicspot.co.uk">woolwich@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day Woolwich GP appointments from Woolwich Late Night Pharmacy. You can easily see a Woolwich GP from our Walk In Clinic Woolwich using National Rail and Docklands Light Railway services from Woolwich Arsenal Station (1-minute walk). Our Woolwich Walk In Centre is conveniently located for commuters, shoppers, and residents in the area looking for a GP near Woolwich Arsenal Station. Skip the wait and book a private GP Woolwich Arsenal appointment at a time that suits you.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3999" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Woolwich_GP_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Woolwich_GP_Clinic_Consultation_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Woolwich_GP_Clinic_Medical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Woolwich GP Today</h1>
            <p>Visit our Woolwich walk in centre to see a private GP</p>
