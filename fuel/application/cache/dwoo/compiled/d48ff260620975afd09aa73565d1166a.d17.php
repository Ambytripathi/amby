...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Notting Hill Doctors Service    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Notting Hill Doctors">
    <meta name="description" content="Same day Notting Hill doctors appointment for only £39. MedicSpot's Notting Hill Doctors Surgery is conveniently located on Pembridge Road inside Notting Hill Pharmacy. Skip the wait, select a time, and book a private GP Notting Hill appointment.">
...
globals = { };
globals.lat = '51.509462';
globals.lng = '-0.196981';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Notting Hill</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See Our Notting Hill Doctors						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Notting Hill</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Notting Hill Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>12 Pembridge Rd, Notting Hill, London W11 3HL, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3661</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:nottinghill@medicspot.co.uk">nottinghill@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Same day Notting Hill doctors appointment from MedicSpot Clinic Notting Hill. You can easily see a private GP from MedicSpot's Notting Hill Doctors Surgery using Central, Circle, or District lines from Notting Hill Underground Station (1-minute walk). Our Private GP Notting Hill Walk In Centre is very close to Bayswater, Holland Park, and Kensington Palace, making it ideal for tourists who are unable to register with an NHS GP. Skip the wait and book a Notting Hill doctors appointment at a time that suits you.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3661" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Notting_Hill_Doctors_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Notting_Hill_Doctors_Clinic_Inside.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Notting_Hill_Doctors_Clinic_Consulting_Room.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Notting Hill GP Today</h1>
            <p>Visit our Notting Hill walk in centre to see a private GP</p>
