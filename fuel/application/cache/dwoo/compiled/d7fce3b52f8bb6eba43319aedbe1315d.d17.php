...
<head>
    ...
    <meta name="keywords" content="<!--__FUEL_MARKER__1-->Blog article keywords">
    <meta name="description" content="<!--__FUEL_MARKER__2-->Blog article description">
		...
		<section id="blog-index-header" class="text-section">
			<div class="container">
				<div class="section-header">
					<h1><!--__FUEL_MARKER__3-->Navigating Through Sick Notes</h1>
