...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Join Our Growing Network of Partner Pharmacies    </title>
	...
	<section id="contact-info" class="dots-background text-section">
		<div class="container">
			<div class="section-header NewPharHead">
				...
				<p class="subtitle"><!--__FUEL_MARKER__1-->Transform your pharmacy into a private clinic by offering online doctor consultations from your consulting room.</p>
			</div>
	...
	<section id="testimonials" class="testimonials GoldTestimonial">
		<div class="container">
			...
			<div class="testimonials-quotes">
				<blockquote>
					<p>
						<!--__FUEL_MARKER__2-->&ldquo;I was very excited when Dr Ahmed first approached me with MedicSpot and I instantly saw why it is such a brilliant concept for both pharmacies and our patients alike. The whole set-up process is very easy and we are able to give our patients a valuable and convenient service&rdquo;	
					</p>
					<footer>
						<img class="testimony-avatar" src="https://www.medicspot.co.uk/assets/images/<!--__FUEL_MARKER__3-->meir_headshot.png">
						<div class="testimony-name"><!--__FUEL_MARKER__4-->Meir Kattan</div>
						<div class="testimony-profession">
							<!--__FUEL_MARKER__5-->Owner & Pharmacist<br>Kalmak Chemist, London						</div>
					</footer>
				</blockquote>
			</div>
		</div>
