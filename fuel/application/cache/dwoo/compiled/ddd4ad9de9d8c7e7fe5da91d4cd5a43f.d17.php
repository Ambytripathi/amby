...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->MedicSpot Same Day Doctor Service - Contact Us    </title>
    	
	
	<meta name="title" content="Contact us meta title">
    <meta name="keywords" content="">
    <meta name="description" content="Contact details for the MedicSpot same day doctor service. Find out more.">
	...
	<section id="contact-info" class="dots-background with-media">
		<div class="container">
			<div class="content">
				<h1>Contact Us</h1>
				<p>
					<!--__FUEL_MARKER__1-->Get in touch with us! We would love to hear from you, please contact us with any queries
<br>
Please note: these methods should not be used to seek medical advice &ndash; only our doctors can give you that during a consultation.
<br>				</p>
	...
	<section id="raise-complaint" class="call-to-action">
		<div class="container">
			...
			<a href="https://www.medicspot.co.uk/complaints" class="btn s-large s-rounded s-inverted">Raise a Complaint</a>
		</div>
	</section>
</page>
...
$( document ).ready(function() { 
	...
	$("#contact").submit(function(e) {  
			e.preventDefault();
			var url = "https://www.medicspot.co.uk/contact_us"; 
