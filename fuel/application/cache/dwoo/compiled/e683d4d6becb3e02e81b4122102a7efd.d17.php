		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Clinic_Paddington.JPG)" aria-label="MedicSpot Clinic Paddington" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Clinic_Paddington_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Paddington" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Clinic_Paddington_Clinical_Station.JPG)" aria-label="MedicSpot Clinic Paddington" ></div>
											</div>
