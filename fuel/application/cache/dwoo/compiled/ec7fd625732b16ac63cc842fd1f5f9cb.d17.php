...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Contact Business    </title>
	...
	<section id="contact-info" class="dots-background text-section">
		<div class="container">
			<div class="section-header">
				...
				<p class="subtitle"><!--__FUEL_MARKER__1-->MedicSpot recognises how important a healthy workforce is to you and how you wish to support your employees with their health and wellbeing.</p>
			</div>
			<div class="content">
				<p>
					<!--__FUEL_MARKER__2-->We have packages available for businesses that aim to do just this. Any of our expanding network of online walk in clinics can be used by your employees to quickly get the medical attention that they need. Reduce the hassle for your staff in getting access to quick, convenient and safe healthcare.				</p>
			</div>
		</div>
	</section>
	...
	<section id="talk-to-us" class="text-section">
		<div class="container">
			...
			<div>
				...
				<a href="https://www.medicspot.co.uk/contact" class="btn s-large">Contact Us</a>
			</div>
		</div>
	</section>
</page>
