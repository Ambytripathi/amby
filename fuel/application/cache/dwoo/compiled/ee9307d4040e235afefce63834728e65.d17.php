...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Skip The Wait - Same Day Private GP Chelsea Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="GP Chelsea">
    <meta name="description" content="Same day private GP in Chelsea for only £39. MedicSpot's GP Chelsea Walk In Centre is conveniently located on King's Road inside Worlds End Pharmacy. Skip the wait and book an appointment with a Chelsea GP at a time that suits you.">
...
globals = { };
globals.lat = '51.481725';
globals.lng = '-0.180568';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Chelsea</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A GP In Chelsea						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Chelsea</p>
				</li>
				<li>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>469 King's Rd, Chelsea, London SW10 0LU, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3686</span>
					</div>
					<div class="establishment-meta-info">
					...
					<div class="establishment-meta-info">
						...
						<span>
							<a href="mailto:chelsea@medicspot.co.uk">chelsea@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Skip the wait and book a private GP Chelsea appointment at a time that suits you. MedicSpot Clinic Chelsea is conveniently located on King's Road inside Worlds End Pharmacy. Our Chelsea GP Clinic is an online private GP service where you can instantly speak to one of our expert NHS registered doctors Monday to Saturday. You no longer have to wait weeks for an appointment with your regular NHS GP in Chelsea - simply select a convenient time and day and book a private GP Chelsea appointment online.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3686" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Chelsea_Clinic.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Chelsea_Clinic_Consulting_Room.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Chelsea_Clinic_Medical_Station.jpg)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Chelsea GP Today</h1>
            <p>Visit our Chelsea walk in centre to see a private GP</p>
