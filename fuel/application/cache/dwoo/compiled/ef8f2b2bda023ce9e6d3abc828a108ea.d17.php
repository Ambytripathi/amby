		...
		<div class="container" id="clinicInfo" >
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Sheffield_Wicker.JPG)" aria-label="MedicSpot Clinic Sheffield Wicker" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Sheffield_Consulting_Room.JPG)" aria-label="MedicSpot Clinic Sheffield Wicker" ></div>
											</div>
					<div class="photo-wrapper">
												<div rol="img" class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/Walk_In_Centre_Sheffield_Clinical_Station.jpg)" aria-label="MedicSpot Clinic Sheffield Wicker" ></div>
											</div>
