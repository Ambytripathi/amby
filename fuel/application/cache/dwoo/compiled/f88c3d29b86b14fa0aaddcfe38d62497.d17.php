...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Walk In GP and Same Day Doctor Service - Treatments    </title>
    	
	
	<meta name="title" content="What We Treat">
    <meta name="keywords" content="">
    <meta name="description" content="Our fully qualified doctors offer a wide range of treatments available same day. Find out more here.">
  ...
  <div class="modal-content">
	...
	<section id="intro" class="dots-background diamond-background text-section">
		<div class="container">
			...
			<div class="content">
				<p>
					<!--__FUEL_MARKER__1-->With our unique MedicSpot stations, our doctors can deal with the vast majority of your health queries that you would normally speak to your GP about. See how we&rsquo;ve helped previous patients.				</p>
	...
	<section id="cannot-treat" class="treat-section">
		<div class="container">
			...
			<ul class="treat-list">
								<li>
					<h3>Suspected Heart Attack or Severe Chest Pain</h3>
				</li>
								<li>
					<h3>Neurological Deficit or Suspected Stroke or Seizures</h3>
				</li>
								<li>
					<h3>Severe or Heavy Bleeding</h3>
				</li>
								<li>
					<h3>Severe or Sudden Onset of Pain</h3>
				</li>
								<li>
					<h3>Severe Mental Health Issues Such as Thoughts of Self Harm, Suicide or Psychosis</h3>
				</li>
								<li>
					<h3>Pregnancy Related Complications</h3>
				</li>
								<li>
					<h3>Major Trauma On Any Part Of The Body</h3>
				</li>
								<li>
					<h3>Unrelenting High Fever</h3>
				</li>
								<li>
					<h3>Children Under 5 Years Old</h3>
				</li>
							</ul>
		</div>
	</section>
	...
	<section id="call-to-action" class="call-to-action">
		<div class="container">
			...
			<a href="https://www.medicspot.co.uk/how-it-works" class="btn s-large s-rounded s-inverted">How it works</a>
	</section>
