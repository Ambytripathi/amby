...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->Skip The Wait - Same Day GP Elephant and Castle Service    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="GP Elephant and Castle">
    <meta name="description" content="Same day GP Elephant and Castle appointment for only £39. MedicSpot's GP Elephant and Castle Walk In Centre is conveniently located on St George's Road inside St Georges Pharmacy. Skip the wait, select a time, and book a private GP appointment.">
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Elephant and Castle</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A GP In Elephant and Castle 						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Elephant and Castle</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Elephant and Castle Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>46 St George's Rd, Newington, London SE1 6ET, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3946 3684</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-clock-o" title="Opening Times"></i>
						<span>
							<strong>Opening Times</strong><br>
							<table cellpadding="10" cellspacing="10"><tr><td>Monday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Tuesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Wednesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Thursday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Friday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Saturday:</td><td> 09:00 to 12:00 </td></tr><tr><td>Sunday:</td><td> Closed</td></tr></table>						</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-envelope" title="Email Address"></i>
						<span>
							<a href="mailto:elephantandcastle@medicspot.co.uk">elephantandcastle@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Skip the wait and book a private GP Elephant and Castle appointment at a time that suits you. You can easily see a private GP from MedicSpot Clinic Elephant and Castle using Northern or Bakerloo lines from Elephant & Castle Underground Station (2-minute walk). MedicSpot's GP Elephant and Castle Walk In Centre is conveniently located on St George's Road inside St Georges Pharmacy, making it ideal for commuters, tourists, and visitors who are reluctant to wait for appointments with their regular GP or do not have the time to register with a new NHS GP.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3946 3684" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Elephant_and_Castle_Clinic.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Elephant_and_Castle_Clinic_Consulting_Room.JPG)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_GP_Elephant_and_Castle_Clinical_Station.JPG)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See An Elephant and Castle GP Today</h1>
            <p>Visit our Elephant and Castle walk in centre to see a private GP</p>
