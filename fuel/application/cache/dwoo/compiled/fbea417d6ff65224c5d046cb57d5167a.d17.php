...
<head>
    ...
    <title>
        <!--__FUEL_MARKER__0-->No More Waiting - Same Day Cricklewood GP Appointments    </title>
    	
	
	<meta name="title" content="">
    <meta name="keywords" content="Cricklewood GP">
    <meta name="description" content="Same day Cricklewood GP appointments for only £39. MedicSpot's Cricklewood GP Surgery is conveniently located on Cricklewood Broadway inside Green Light Pharmacy. Skip the wait, select a time, and book a private Cricklewood doctors appointment.">
...
globals = { };
globals.lat = '51.55285';
globals.lng = '-0.210386';
	...
	<section id="testimonials" class="testimonials m_top_30">
		<div class="container">
			<div class="section-header NewSecHeader" id="Reviews">
				<h1>
					Private GP Services At<span>  MedicSpot Clinic Cricklewood</span>				</h1>
				<p class="subtitle">Same Day Online Doctor Service</p>
				<p class="subtitle heading02" >
					Book To See A Cricklewood GP						
				</p>
		...
		<div class="container">
			...
			<ul class="steps-list">
				<li>
					...
					<h3>Book Online</h3>
					<p>Book a convenient same day private GP appointment in MedicSpot Clinic Cricklewood</p>
				</li>
				<li>
					<img class="step-icon" src="https://www.medicspot.co.uk/assets/images/icons/Online-Doctor.png">
					<h3>Visit Our Cricklewood Clinic</h3>
		...
		<div class="container" id="clinicInfo" >
			<div class="establishment-info" >
				<div class="establishment-meta">
					<div class="establishment-meta-info" >
						...
						<span>6 Cricklewood Broadway, Cricklewood, London NW2 3HD, United Kingdom</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-phone" title="Phone Number"></i>
						<span>020 3937 5656</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-clock-o" title="Opening Times"></i>
						<span>
							<strong>Opening Times</strong><br>
							<table cellpadding="10" cellspacing="10"><tr><td>Monday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Tuesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Wednesday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Thursday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Friday:</td><td> 09:00 to 18:00 </td></tr><tr><td>Saturday:</td><td> 09:00 to 13:00 </td></tr><tr><td>Sunday:</td><td> Closed</td></tr></table>						</span>
					</div>
					<div class="establishment-meta-info">
						<i class="fa fa-envelope" title="Email Address"></i>
						<span>
							<a href="mailto:cricklewood@medicspot.co.uk">cricklewood@medicspot.co.uk</a>
						</span>
					</div>
				</div>

				<div class="right_establish_cntnt">
					<p>Skip the wait and book a Cricklewood doctors appointment at a time that suits you. You can easily see a same day doctor from MedicSpot's Cricklewood GP Surgery using the Jubilee line from Kilburn Underground Station (10-minute walk) or Thameslink services from Cricklewood Station (10-minute walk). MedicSpot's Cricklewood Surgery is very near Dollis Hill, Childs Hill, and Fortune Green, making it ideal for residents who are reluctant to wait for appointments with their regular Cricklewood NHS Surgery. Simply select a time and book online to see a private Cricklewood GP instantly.</p>
					<div class="innRightEstCntct">
						...
						<a href="callto:020 3937 5656" class="btn">Call <img src="https://www.medicspot.co.uk/assets/images/icons/icon-8.png" alt="" ></a>
					</div>
				</div>
			...
			<div class="establishment-info-photos">
									<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clinic_Cricklewood_Consulting_Room.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clinic_Cricklewood_GP_Surgery_Outside.jpg)"></div>
											</div>
					<div class="photo-wrapper">
												<div class="photo" style="background-image: url(https://www.medicspot.co.uk/assets/images/MedicSpot_Clinic_Cricklewood_Virtual_Consultation.jpg)"></div>
											</div>
...
<page id="how-it-works">
	...
	<section id="call-to-action" class="call-to-action">
        <div class="container">
            <h1>See A Cricklewood GP Today</h1>
            <p>Visit our Cricklewood walk in centre to see a private GP</p>
