...
class Email {
    ...
    public function sendAppointmentDetails(array $appointment, array $provider, array $service,
        ...
        $replaceArray = array(
            ...
            '$address' => $appointment['clinic']['cl_formatted_address'],
            '$clinic_name' => $appointment['clinic']['cl_clinic_name'],
			'$pharmacy_name' => $appointment['clinic']['pharmacy_name'],
        ...
        //echo $replaceArray['$address'];
        //echo $replaceArray['$clinic_name'];
        $html = file_get_contents(__DIR__ . '/../../views/emails/appointment_details.php');
        ...
        $mailer->Body    = $html;
        $mailer->addCustomHeader("BCC: info@medicspot.co.uk");
    ...
    public function sendDeleteAppointment(array $appointment, array $provider,
        ...
        $html = file_get_contents(__DIR__ . '/../../views/emails/delete_appointment.php');
        $html = $this->_replaceTemplateVariables($replaceArray, $html);
    ...
    public function sendPassword(NonEmptyText $password, EmailAddress $recipientEmail, array $company) {
        ...
        $html = file_get_contents(__DIR__ . '/../../views/emails/new_password.php');
        $html = $this->_replaceTemplateVariables($replaceArray, $html);
