			...
			<div class="testimonials-quotes testimonials-slicky">
				<div>
					<blockquote>
						...
						<footer>
							<img class="testimony-avatar" src="<?php echo base_url('assets/images/Jacqueline.png');?>" alt="Photo of Jacqueline smiling outside the private GP practice" >
				...
				<div>
					<blockquote>
						...
						<footer>
							<img class="testimony-avatar" src="<?php echo base_url('assets/images/kelly2.png');?>" alt="Photo of Kelly smiling after her private GP appointment" >
				...
				<div>
					<blockquote>
						...
						<footer>
							<img class="testimony-avatar" src="<?php echo base_url('assets/images/michael2.png');?>" alt="Photo of Michael smiling with red bow tie">
				...
				<div>
					<blockquote>
						...
						<footer>
							<img class="testimony-avatar" src="<?php echo base_url('assets/images/nolan2.png');?>" alt="nolan2.png" >
				...
				<div>
					<blockquote>
						...
						<footer>
							<img class="testimony-avatar" src="<?php echo base_url('assets/images/trevor2.png');?>" alt="Photo of Trevor smiling inside private GP consultation room" >
			...
			<div class="establishment-info-photos">
				...
				if ($data['1_image']!='' && $data['2_image']!='' && $data['3_image']!='') {
					...
					<div class="photo-wrapper">
						<?php if($data['1_image']!=''){?>
						<div rol="img" class="photo" style="background-image: url(<?php echo base_url('assets/images/'.$data['1_image']);?>)" aria-label="<?php echo $data['cl_clinic_name'];?>" ></div>
						<?php } ?>
					</div>
					<div class="photo-wrapper">
						<?php if($data['2_image']!=''){?>
						<div rol="img" class="photo" style="background-image: url(<?php echo base_url('assets/images/'.$data['2_image']);?>)" aria-label="<?php echo $data['cl_clinic_name'];?>" ></div>
						<?php } ?>
					</div>
					<div class="photo-wrapper">
						<?php if($data['3_image']!=''){?>
						<div rol="img" class="photo" style="background-image: url(<?php echo base_url('assets/images/'.$data['3_image']);?>)" aria-label="<?php echo $data['cl_clinic_name'];?>" ></div>
						<?php } ?>
					</div>
					<?php
