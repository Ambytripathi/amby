    ...
    <div class="container-fluid">
        ...
        <div id="header-menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php $hidden = ($privileges[PRIV_APPOINTMENTS]['view'] == TRUE) ? '' : 'hidden'; ?>
                <li class="<?php echo $active . $hidden; ?>">
                    <a href="<?php echo site_url('Clinics_info'); ?>" class="menu-item"
                            title="<?php echo $this->lang->line('add_clinic_hint'); ?>">
                        <?php echo $this->lang->line('clinics'); ?>
                    </a>
                </li>
...
<div id="loading" style="display: none;">
    <img src="<?php echo $base_url; ?>/assets/img/loading.gif" alt="Circular loading gif" />
</div>
