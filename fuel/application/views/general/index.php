<page id="home">
	...
	<section id="logos-media">
		<div class="container">
			...
			<div class="logos-list">
				<img src="<?php echo base_url('assets/img/logo/logo-bbc.png');?>" title="BBC" alt="BBC logo" >
				<img src="<?php echo base_url('assets/img/logo/logo-metro.png');?>" title="Metro" alt="Metro logo" >
				<img src="<?php echo base_url('assets/img/logo/logo-pj.png');?>" title="The Pharmaceutical Journal" tag="The Pharmaceutical Journal logo" >
				<img src="<?php echo base_url('assets/img/logo/logo-et.png');?>" title="Evening Times" alt="Evening Times logo"  >
				<img src="<?php echo base_url('assets/img/logo/logo-pulse.png');?>" title="Pulse" alt="Pulse logo" >
			</div>
		</div>
	</section>
