            ...
            <div class="page-header-wrapper">
                ...
                <nav class="nav-main">
                    <div class="mobile-menu-header">
                        <a href="<?php echo base_url();?>" class="page-logo" title="Medicspot">Medicspot</a>
                    ...
                    <a href="<?php echo base_url('our-clinics');?>" class="btn bokNowbtn">Book Now</a>
...
<script type="text/javascript">
        ...
        <section id="intro" class="dots-background diamond-background text-section">
            <div class="main">
                <div>
                    ...
                    <p style="text-align:center">For some reason the page you requested could not be found on our server</p>
                </div>
    ...
    $( document ).ready(function() {
        ...
        //var anch = document.getElementById("chatteam");
